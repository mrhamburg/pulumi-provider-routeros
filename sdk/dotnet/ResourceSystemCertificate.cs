...
namespace Pulumi.Routeros
{
    ...
    /// {
    ///     var rootCa = new Routeros.ResourceSystemCertificate("rootCa", new()
    ///     {
    ///         CommonName = "RootCA",
    ///         KeyUsages = new[]
    ///         {
    ...
    ///     var serverCrt = new Routeros.ResourceSystemCertificate("serverCrt", new()
    ///     {
    ...
    ///     });
    /// 
    ///     var clientCrt = new Routeros.ResourceSystemCertificate("clientCrt", new()
    ///     {
    ...
    ///     });
    /// 
    ///     var unsignedCrt = new Routeros.ResourceSystemCertificate("unsignedCrt", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [RouterosResourceType("routeros:index/resourceSystemCertificate:ResourceSystemCertificate")]
    public partial class ResourceSystemCertificate : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        [Output("signs")]
        public Output<ImmutableArray<Outputs.ResourceSystemCertificateSign>> Signs { get; private set; } = null!;
        ...
        public ResourceSystemCertificate(string name, ResourceSystemCertificateArgs args, CustomResourceOptions? options = null)
            : base("routeros:index/resourceSystemCertificate:ResourceSystemCertificate", name, args ?? new ResourceSystemCertificateArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ResourceSystemCertificate(string name, Input<string> id, ResourceSystemCertificateState? state = null, CustomResourceOptions? options = null)
            : base("routeros:index/resourceSystemCertificate:ResourceSystemCertificate", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static ResourceSystemCertificate Get(string name, Input<string> id, ResourceSystemCertificateState? state = null, CustomResourceOptions? options = null)
        {
            return new ResourceSystemCertificate(name, id, state, options);
        }
    }

    public sealed class ResourceSystemCertificateArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// &lt;em&gt;Resource ID type (.id / name). This is an internal service field, setting a value is not required.&lt;/em&gt;
        /// </summary>
        ...
        [Input("signs")]
        private InputList<Inputs.ResourceSystemCertificateSignArgs>? _signs;
        public InputList<Inputs.ResourceSystemCertificateSignArgs> Signs
        {
            get => _signs ?? (_signs = new InputList<Inputs.ResourceSystemCertificateSignArgs>());
            set => _signs = value;
        }
        ...
        public ResourceSystemCertificateArgs()
        {
        }
        public static new ResourceSystemCertificateArgs Empty => new ResourceSystemCertificateArgs();
    }

    public sealed class ResourceSystemCertificateState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// &lt;em&gt;Resource ID type (.id / name). This is an internal service field, setting a value is not required.&lt;/em&gt;
        /// </summary>
        ...
        [Input("signs")]
        private InputList<Inputs.ResourceSystemCertificateSignGetArgs>? _signs;
        public InputList<Inputs.ResourceSystemCertificateSignGetArgs> Signs
        {
            get => _signs ?? (_signs = new InputList<Inputs.ResourceSystemCertificateSignGetArgs>());
            set => _signs = value;
        }
        ...
        public ResourceSystemCertificateState()
        {
        }
        public static new ResourceSystemCertificateState Empty => new ResourceSystemCertificateState();
    }
}
