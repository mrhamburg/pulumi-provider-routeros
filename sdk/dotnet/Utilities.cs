...
namespace Pulumi.Routeros
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.Routeros.version.txt");
    ...
    internal sealed class RouterosResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public RouterosResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
