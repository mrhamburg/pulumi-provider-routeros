...
namespace Pulumi.Routeros.Inputs
{
    ...
    public sealed class DatasourceFirewallRuleInputArgs : global::Pulumi.ResourceArgs
    {
        ...
        [Input("hwOffload", required: true)]
        public Input<bool> HwOffload { get; set; } = null!;
        ...
        [Input("rejectWith", required: true)]
        public Input<string> RejectWith { get; set; } = null!;

        [Input("routingMark", required: true)]
        public Input<string> RoutingMark { get; set; } = null!;

        [Input("routingTable", required: true)]
        public Input<string> RoutingTable { get; set; } = null!;
        ...
        public DatasourceFirewallRuleInputArgs()
        {
        }
        public static new DatasourceFirewallRuleInputArgs Empty => new DatasourceFirewallRuleInputArgs();
    }
}
