...
namespace Pulumi.Routeros.Inputs
{
    ...
    public sealed class DatasourceFirewallNatInputArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<bool> SameNotByDst { get; set; } = null!;
        ...
        public Input<string> ToAddresses { get; set; } = null!;

        [Input("toPorts", required: true)]
        public Input<string> ToPorts { get; set; } = null!;

        [Input("ttl", required: true)]
        public Input<string> Ttl { get; set; } = null!;

        public DatasourceFirewallNatInputArgs()
        {
        }
        public static new DatasourceFirewallNatInputArgs Empty => new DatasourceFirewallNatInputArgs();
    }
}
