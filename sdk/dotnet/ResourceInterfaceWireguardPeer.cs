...
namespace Pulumi.Routeros
{
    ...
    /// {
    ///     var testWgInterface = new Routeros.ResourceInterfaceWireguard("testWgInterface", new()
    ///     {
    ///         ListenPort = 13231,
    ///     });
    /// 
    ///     var wgPeer = new Routeros.ResourceInterfaceWireguardPeer("wgPeer", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [RouterosResourceType("routeros:index/resourceInterfaceWireguardPeer:ResourceInterfaceWireguardPeer")]
    public partial class ResourceInterfaceWireguardPeer : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        /// <summary>
        /// Create a ResourceInterfaceWireguardPeer resource with the given unique name, arguments, and options.
        /// </summary>
        ///
        /// <param name="name">The unique name of the resource</param>
        /// <param name="args">The arguments used to populate this resource's properties</param>
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public ResourceInterfaceWireguardPeer(string name, ResourceInterfaceWireguardPeerArgs args, CustomResourceOptions? options = null)
            : base("routeros:index/resourceInterfaceWireguardPeer:ResourceInterfaceWireguardPeer", name, args ?? new ResourceInterfaceWireguardPeerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ResourceInterfaceWireguardPeer(string name, Input<string> id, ResourceInterfaceWireguardPeerState? state = null, CustomResourceOptions? options = null)
            : base("routeros:index/resourceInterfaceWireguardPeer:ResourceInterfaceWireguardPeer", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <summary>
        /// Get an existing ResourceInterfaceWireguardPeer resource's state with the given name, ID, and optional extra
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static ResourceInterfaceWireguardPeer Get(string name, Input<string> id, ResourceInterfaceWireguardPeerState? state = null, CustomResourceOptions? options = null)
        {
            return new ResourceInterfaceWireguardPeer(name, id, state, options);
        }
    }

    public sealed class ResourceInterfaceWireguardPeerArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// &lt;em&gt;Resource ID type (.id / name). This is an internal service field, setting a value is not required.&lt;/em&gt;
        /// </summary>
        ...
        public ResourceInterfaceWireguardPeerArgs()
        {
        }
        public static new ResourceInterfaceWireguardPeerArgs Empty => new ResourceInterfaceWireguardPeerArgs();
    }

    public sealed class ResourceInterfaceWireguardPeerState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// &lt;em&gt;Resource ID type (.id / name). This is an internal service field, setting a value is not required.&lt;/em&gt;
        /// </summary>
        ...
        public ResourceInterfaceWireguardPeerState()
        {
        }
        public static new ResourceInterfaceWireguardPeerState Empty => new ResourceInterfaceWireguardPeerState();
    }
}
