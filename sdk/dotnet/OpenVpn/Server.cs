...
namespace Pulumi.Routeros.OpenVpn
{
    /// <summary>
    ...
    /// ```
    /// </summary>
    [RouterosResourceType("routeros:OpenVpn/server:Server")]
    public partial class Server : global::Pulumi.CustomResource
    {
        ...
        public Server(string name, ServerArgs args, CustomResourceOptions? options = null)
            : base("routeros:OpenVpn/server:Server", name, args ?? new ServerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Server(string name, Input<string> id, ServerState? state = null, CustomResourceOptions? options = null)
            : base("routeros:OpenVpn/server:Server", name, state, MakeResourceOptions(options, id))
        {
        }
