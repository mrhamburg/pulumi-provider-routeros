...
namespace Pulumi.Routeros.CapsMan
{
    ...
    /// ```
    /// </summary>
    [RouterosResourceType("routeros:CapsMan/security:Security")]
    public partial class Security : global::Pulumi.CustomResource
    {
        ...
        public Security(string name, SecurityArgs? args = null, CustomResourceOptions? options = null)
            : base("routeros:CapsMan/security:Security", name, args ?? new SecurityArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Security(string name, Input<string> id, SecurityState? state = null, CustomResourceOptions? options = null)
            : base("routeros:CapsMan/security:Security", name, state, MakeResourceOptions(options, id))
        {
        }
