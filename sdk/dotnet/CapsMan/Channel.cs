...
namespace Pulumi.Routeros.CapsMan
{
    ...
    /// ```
    /// </summary>
    [RouterosResourceType("routeros:CapsMan/channel:Channel")]
    public partial class Channel : global::Pulumi.CustomResource
    {
        ...
        public Channel(string name, ChannelArgs? args = null, CustomResourceOptions? options = null)
            : base("routeros:CapsMan/channel:Channel", name, args ?? new ChannelArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Channel(string name, Input<string> id, ChannelState? state = null, CustomResourceOptions? options = null)
            : base("routeros:CapsMan/channel:Channel", name, state, MakeResourceOptions(options, id))
        {
        }
