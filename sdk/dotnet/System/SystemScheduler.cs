...
namespace Pulumi.Routeros.System
{
    ...
    /// ```
    /// </summary>
    [RouterosResourceType("routeros:System/systemScheduler:SystemScheduler")]
    public partial class SystemScheduler : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        public SystemScheduler(string name, SystemSchedulerArgs args, CustomResourceOptions? options = null)
            : base("routeros:System/systemScheduler:SystemScheduler", name, args ?? new SystemSchedulerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SystemScheduler(string name, Input<string> id, SystemSchedulerState? state = null, CustomResourceOptions? options = null)
            : base("routeros:System/systemScheduler:SystemScheduler", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static SystemScheduler Get(string name, Input<string> id, SystemSchedulerState? state = null, CustomResourceOptions? options = null)
        {
            return new SystemScheduler(name, id, state, options);
        }
    }

    public sealed class SystemSchedulerArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// &lt;em&gt;Resource ID type (.id / name). This is an internal service field, setting a value is not required.&lt;/em&gt;
        /// </summary>
        ...
        public SystemSchedulerArgs()
        {
        }
        public static new SystemSchedulerArgs Empty => new SystemSchedulerArgs();
    }

    public sealed class SystemSchedulerState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// &lt;em&gt;Resource ID type (.id / name). This is an internal service field, setting a value is not required.&lt;/em&gt;
        /// </summary>
        ...
        public SystemSchedulerState()
        {
        }
        public static new SystemSchedulerState Empty => new SystemSchedulerState();
    }
}
