...
namespace Pulumi.Routeros
{
    ...
    /// {
    ///     var testDatapath = new Routeros.ResourceCapsManDatapath("testDatapath", new()
    ///     {
    ///         Arp = "local-proxy-arp",
    ///         Bridge = "bridge",
    ///         BridgeCost = 100,
    ...
    /// ```
    /// </summary>
    [RouterosResourceType("routeros:index/resourceCapsManDatapath:ResourceCapsManDatapath")]
    public partial class ResourceCapsManDatapath : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        public ResourceCapsManDatapath(string name, ResourceCapsManDatapathArgs? args = null, CustomResourceOptions? options = null)
            : base("routeros:index/resourceCapsManDatapath:ResourceCapsManDatapath", name, args ?? new ResourceCapsManDatapathArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ResourceCapsManDatapath(string name, Input<string> id, ResourceCapsManDatapathState? state = null, CustomResourceOptions? options = null)
            : base("routeros:index/resourceCapsManDatapath:ResourceCapsManDatapath", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static ResourceCapsManDatapath Get(string name, Input<string> id, ResourceCapsManDatapathState? state = null, CustomResourceOptions? options = null)
        {
            return new ResourceCapsManDatapath(name, id, state, options);
        }
    }

    public sealed class ResourceCapsManDatapathArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// &lt;em&gt;Resource ID type (.id / name). This is an internal service field, setting a value is not required.&lt;/em&gt;
        /// </summary>
        ...
        public ResourceCapsManDatapathArgs()
        {
        }
        public static new ResourceCapsManDatapathArgs Empty => new ResourceCapsManDatapathArgs();
    }

    public sealed class ResourceCapsManDatapathState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// &lt;em&gt;Resource ID type (.id / name). This is an internal service field, setting a value is not required.&lt;/em&gt;
        /// </summary>
        ...
        public ResourceCapsManDatapathState()
        {
        }
        public static new ResourceCapsManDatapathState Empty => new ResourceCapsManDatapathState();
    }
}
