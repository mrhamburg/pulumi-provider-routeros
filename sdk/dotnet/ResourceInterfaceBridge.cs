...
namespace Pulumi.Routeros
{
    ...
    /// {
    ///     var bridge = new Routeros.ResourceInterfaceBridge("bridge", new()
    ///     {
    ///         VlanFiltering = true,
    ///     });
    /// 
    ...
    /// ```
    /// </summary>
    [RouterosResourceType("routeros:index/resourceInterfaceBridge:ResourceInterfaceBridge")]
    public partial class ResourceInterfaceBridge : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        public ResourceInterfaceBridge(string name, ResourceInterfaceBridgeArgs? args = null, CustomResourceOptions? options = null)
            : base("routeros:index/resourceInterfaceBridge:ResourceInterfaceBridge", name, args ?? new ResourceInterfaceBridgeArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ResourceInterfaceBridge(string name, Input<string> id, ResourceInterfaceBridgeState? state = null, CustomResourceOptions? options = null)
            : base("routeros:index/resourceInterfaceBridge:ResourceInterfaceBridge", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static ResourceInterfaceBridge Get(string name, Input<string> id, ResourceInterfaceBridgeState? state = null, CustomResourceOptions? options = null)
        {
            return new ResourceInterfaceBridge(name, id, state, options);
        }
    }

    public sealed class ResourceInterfaceBridgeArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// &lt;em&gt;Resource ID type (.id / name). This is an internal service field, setting a value is not required.&lt;/em&gt;
        /// </summary>
        ...
        public ResourceInterfaceBridgeArgs()
        {
        }
        public static new ResourceInterfaceBridgeArgs Empty => new ResourceInterfaceBridgeArgs();
    }

    public sealed class ResourceInterfaceBridgeState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// &lt;em&gt;Resource ID type (.id / name). This is an internal service field, setting a value is not required.&lt;/em&gt;
        /// </summary>
        ...
        public ResourceInterfaceBridgeState()
        {
        }
        public static new ResourceInterfaceBridgeState Empty => new ResourceInterfaceBridgeState();
    }
}
