...
namespace Pulumi.Routeros
{
    ...
    /// {
    ///     var aRoute = new Routeros.ResourceIPRoute("aRoute", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [RouterosResourceType("routeros:index/resourceIPRoute:ResourceIPRoute")]
    public partial class ResourceIPRoute : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        /// </summary>
        [Output("checkGateway")]
        public Output<string?> CheckGateway { get; private set; } = null!;
        ...
        /// <summary>
        /// Create a ResourceIPRoute resource with the given unique name, arguments, and options.
        /// </summary>
        ///
        /// <param name="name">The unique name of the resource</param>
        /// <param name="args">The arguments used to populate this resource's properties</param>
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public ResourceIPRoute(string name, ResourceIPRouteArgs args, CustomResourceOptions? options = null)
            : base("routeros:index/resourceIPRoute:ResourceIPRoute", name, args ?? new ResourceIPRouteArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ResourceIPRoute(string name, Input<string> id, ResourceIPRouteState? state = null, CustomResourceOptions? options = null)
            : base("routeros:index/resourceIPRoute:ResourceIPRoute", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <summary>
        /// Get an existing ResourceIPRoute resource's state with the given name, ID, and optional extra
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static ResourceIPRoute Get(string name, Input<string> id, ResourceIPRouteState? state = null, CustomResourceOptions? options = null)
        {
            return new ResourceIPRoute(name, id, state, options);
        }
    }

    public sealed class ResourceIPRouteArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// &lt;em&gt;Resource ID type (.id / name). This is an internal service field, setting a value is not required.&lt;/em&gt;
        /// </summary>
        ...
        /// </summary>
        [Input("checkGateway")]
        public Input<string>? CheckGateway { get; set; }
        ...
        public ResourceIPRouteArgs()
        {
        }
        public static new ResourceIPRouteArgs Empty => new ResourceIPRouteArgs();
    }

    public sealed class ResourceIPRouteState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// &lt;em&gt;Resource ID type (.id / name). This is an internal service field, setting a value is not required.&lt;/em&gt;
        /// </summary>
        ...
        public ResourceIPRouteState()
        {
        }
        public static new ResourceIPRouteState Empty => new ResourceIPRouteState();
    }
}
