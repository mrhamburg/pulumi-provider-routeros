...
namespace Pulumi.Routeros
{
    ...
    /// </summary>
    [RouterosResourceType("routeros:index/resourceDns:ResourceDns")]
    public partial class ResourceDns : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        public ResourceDns(string name, ResourceDnsArgs? args = null, CustomResourceOptions? options = null)
            : base("routeros:index/resourceDns:ResourceDns", name, args ?? new ResourceDnsArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ResourceDns(string name, Input<string> id, ResourceDnsState? state = null, CustomResourceOptions? options = null)
            : base("routeros:index/resourceDns:ResourceDns", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static ResourceDns Get(string name, Input<string> id, ResourceDnsState? state = null, CustomResourceOptions? options = null)
        {
            return new ResourceDns(name, id, state, options);
        }
    }

    public sealed class ResourceDnsArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// &lt;em&gt;Resource ID type (.id / name). This is an internal service field, setting a value is not required.&lt;/em&gt;
        /// </summary>
        ...
        public ResourceDnsArgs()
        {
        }
        public static new ResourceDnsArgs Empty => new ResourceDnsArgs();
    }

    public sealed class ResourceDnsState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// &lt;em&gt;Resource ID type (.id / name). This is an internal service field, setting a value is not required.&lt;/em&gt;
        /// </summary>
        ...
        public ResourceDnsState()
        {
        }
        public static new ResourceDnsState Empty => new ResourceDnsState();
    }
}
