...
namespace Pulumi.Routeros
{
    ...
    /// ```
    /// </summary>
    [RouterosResourceType("routeros:index/resourceDnsRecord:ResourceDnsRecord")]
    public partial class ResourceDnsRecord : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        public ResourceDnsRecord(string name, ResourceDnsRecordArgs args, CustomResourceOptions? options = null)
            : base("routeros:index/resourceDnsRecord:ResourceDnsRecord", name, args ?? new ResourceDnsRecordArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ResourceDnsRecord(string name, Input<string> id, ResourceDnsRecordState? state = null, CustomResourceOptions? options = null)
            : base("routeros:index/resourceDnsRecord:ResourceDnsRecord", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static ResourceDnsRecord Get(string name, Input<string> id, ResourceDnsRecordState? state = null, CustomResourceOptions? options = null)
        {
            return new ResourceDnsRecord(name, id, state, options);
        }
    }

    public sealed class ResourceDnsRecordArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// &lt;em&gt;Resource ID type (.id / name). This is an internal service field, setting a value is not required.&lt;/em&gt;
        /// </summary>
        ...
        public ResourceDnsRecordArgs()
        {
        }
        public static new ResourceDnsRecordArgs Empty => new ResourceDnsRecordArgs();
    }

    public sealed class ResourceDnsRecordState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// &lt;em&gt;Resource ID type (.id / name). This is an internal service field, setting a value is not required.&lt;/em&gt;
        /// </summary>
        ...
        public ResourceDnsRecordState()
        {
        }
        public static new ResourceDnsRecordState Empty => new ResourceDnsRecordState();
    }
}
