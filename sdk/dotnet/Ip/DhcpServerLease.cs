...
namespace Pulumi.Routeros.Ip
{
    ...
    /// </summary>
    [RouterosResourceType("routeros:Ip/dhcpServerLease:DhcpServerLease")]
    public partial class DhcpServerLease : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        public DhcpServerLease(string name, DhcpServerLeaseArgs args, CustomResourceOptions? options = null)
            : base("routeros:Ip/dhcpServerLease:DhcpServerLease", name, args ?? new DhcpServerLeaseArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DhcpServerLease(string name, Input<string> id, DhcpServerLeaseState? state = null, CustomResourceOptions? options = null)
            : base("routeros:Ip/dhcpServerLease:DhcpServerLease", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static DhcpServerLease Get(string name, Input<string> id, DhcpServerLeaseState? state = null, CustomResourceOptions? options = null)
        {
            return new DhcpServerLease(name, id, state, options);
        }
    }

    public sealed class DhcpServerLeaseArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// &lt;em&gt;Resource ID type (.id / name). This is an internal service field, setting a value is not required.&lt;/em&gt;
        /// </summary>
        ...
        public DhcpServerLeaseArgs()
        {
        }
        public static new DhcpServerLeaseArgs Empty => new DhcpServerLeaseArgs();
    }

    public sealed class DhcpServerLeaseState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// &lt;em&gt;Resource ID type (.id / name). This is an internal service field, setting a value is not required.&lt;/em&gt;
        /// </summary>
        ...
        public DhcpServerLeaseState()
        {
        }
        public static new DhcpServerLeaseState Empty => new DhcpServerLeaseState();
    }
}
