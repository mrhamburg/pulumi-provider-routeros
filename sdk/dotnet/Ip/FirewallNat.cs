...
{
    /// <summary>
    /// ## # routeros.Ip.FirewallNat (Resource)
    /// 
    /// ***
    /// 
    ...
    /// </summary>
    [RouterosResourceType("routeros:Ip/firewallNat:FirewallNat")]
    public partial class FirewallNat : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        /// <summary>
        /// Create a FirewallNat resource with the given unique name, arguments, and options.
        /// </summary>
        ///
        /// <param name="name">The unique name of the resource</param>
        /// <param name="args">The arguments used to populate this resource's properties</param>
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public FirewallNat(string name, FirewallNatArgs args, CustomResourceOptions? options = null)
            : base("routeros:Ip/firewallNat:FirewallNat", name, args ?? new FirewallNatArgs(), MakeResourceOptions(options, ""))
        {
        }

        private FirewallNat(string name, Input<string> id, FirewallNatState? state = null, CustomResourceOptions? options = null)
            : base("routeros:Ip/firewallNat:FirewallNat", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static FirewallNat Get(string name, Input<string> id, FirewallNatState? state = null, CustomResourceOptions? options = null)
        {
            return new FirewallNat(name, id, state, options);
        }
    }

    public sealed class FirewallNatArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// &lt;em&gt;Resource ID type (.id / name). This is an internal service field, setting a value is not required.&lt;/em&gt;
        /// </summary>
        ...
        public FirewallNatArgs()
        {
        }
        public static new FirewallNatArgs Empty => new FirewallNatArgs();
    }

    public sealed class FirewallNatState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// &lt;em&gt;Resource ID type (.id / name). This is an internal service field, setting a value is not required.&lt;/em&gt;
        /// </summary>
        ...
        public FirewallNatState()
        {
        }
        public static new FirewallNatState Empty => new FirewallNatState();
    }
}
