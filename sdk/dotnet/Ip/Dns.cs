...
namespace Pulumi.Routeros.Ip
{
    ...
    /// </summary>
    [RouterosResourceType("routeros:Ip/dns:Dns")]
    public partial class Dns : global::Pulumi.CustomResource
    {
        ...
        public Dns(string name, DnsArgs? args = null, CustomResourceOptions? options = null)
            : base("routeros:Ip/dns:Dns", name, args ?? new DnsArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Dns(string name, Input<string> id, DnsState? state = null, CustomResourceOptions? options = null)
            : base("routeros:Ip/dns:Dns", name, state, MakeResourceOptions(options, id))
        {
        }
