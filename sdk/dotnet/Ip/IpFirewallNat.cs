...
namespace Pulumi.Routeros.Ip
{
    ...
    /// ```
    /// </summary>
    [RouterosResourceType("routeros:Ip/ipFirewallNat:IpFirewallNat")]
    public partial class IpFirewallNat : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        public IpFirewallNat(string name, IpFirewallNatArgs args, CustomResourceOptions? options = null)
            : base("routeros:Ip/ipFirewallNat:IpFirewallNat", name, args ?? new IpFirewallNatArgs(), MakeResourceOptions(options, ""))
        {
        }

        private IpFirewallNat(string name, Input<string> id, IpFirewallNatState? state = null, CustomResourceOptions? options = null)
            : base("routeros:Ip/ipFirewallNat:IpFirewallNat", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static IpFirewallNat Get(string name, Input<string> id, IpFirewallNatState? state = null, CustomResourceOptions? options = null)
        {
            return new IpFirewallNat(name, id, state, options);
        }
    }

    public sealed class IpFirewallNatArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// &lt;em&gt;Resource ID type (.id / name). This is an internal service field, setting a value is not required.&lt;/em&gt;
        /// </summary>
        ...
        public IpFirewallNatArgs()
        {
        }
        public static new IpFirewallNatArgs Empty => new IpFirewallNatArgs();
    }

    public sealed class IpFirewallNatState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// &lt;em&gt;Resource ID type (.id / name). This is an internal service field, setting a value is not required.&lt;/em&gt;
        /// </summary>
        ...
        public IpFirewallNatState()
        {
        }
        public static new IpFirewallNatState Empty => new IpFirewallNatState();
    }
}
