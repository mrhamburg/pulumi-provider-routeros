...
namespace Pulumi.Routeros.Ip
{
    ...
    /// ```
    /// </summary>
    [RouterosResourceType("routeros:Ip/dhcpIpClient:DhcpIpClient")]
    public partial class DhcpIpClient : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        /// <summary>
        /// Create a DhcpIpClient resource with the given unique name, arguments, and options.
        /// </summary>
        ///
        /// <param name="name">The unique name of the resource</param>
        /// <param name="args">The arguments used to populate this resource's properties</param>
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public DhcpIpClient(string name, DhcpIpClientArgs args, CustomResourceOptions? options = null)
            : base("routeros:Ip/dhcpIpClient:DhcpIpClient", name, args ?? new DhcpIpClientArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DhcpIpClient(string name, Input<string> id, DhcpIpClientState? state = null, CustomResourceOptions? options = null)
            : base("routeros:Ip/dhcpIpClient:DhcpIpClient", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static DhcpIpClient Get(string name, Input<string> id, DhcpIpClientState? state = null, CustomResourceOptions? options = null)
        {
            return new DhcpIpClient(name, id, state, options);
        }
    }

    public sealed class DhcpIpClientArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// &lt;em&gt;Resource ID type (.id / name). This is an internal service field, setting a value is not required.&lt;/em&gt;
        /// </summary>
        ...
        public DhcpIpClientArgs()
        {
        }
        public static new DhcpIpClientArgs Empty => new DhcpIpClientArgs();
    }

    public sealed class DhcpIpClientState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// &lt;em&gt;Resource ID type (.id / name). This is an internal service field, setting a value is not required.&lt;/em&gt;
        /// </summary>
        ...
        public DhcpIpClientState()
        {
        }
        public static new DhcpIpClientState Empty => new DhcpIpClientState();
    }
}
