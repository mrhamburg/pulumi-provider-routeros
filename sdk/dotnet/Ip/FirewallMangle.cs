...
namespace Pulumi.Routeros.Ip
{
    ...
    /// </summary>
    [RouterosResourceType("routeros:Ip/firewallMangle:FirewallMangle")]
    public partial class FirewallMangle : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        public FirewallMangle(string name, FirewallMangleArgs args, CustomResourceOptions? options = null)
            : base("routeros:Ip/firewallMangle:FirewallMangle", name, args ?? new FirewallMangleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private FirewallMangle(string name, Input<string> id, FirewallMangleState? state = null, CustomResourceOptions? options = null)
            : base("routeros:Ip/firewallMangle:FirewallMangle", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static FirewallMangle Get(string name, Input<string> id, FirewallMangleState? state = null, CustomResourceOptions? options = null)
        {
            return new FirewallMangle(name, id, state, options);
        }
    }

    public sealed class FirewallMangleArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// &lt;em&gt;Resource ID type (.id / name). This is an internal service field, setting a value is not required.&lt;/em&gt;
        /// </summary>
        ...
        public FirewallMangleArgs()
        {
        }
        public static new FirewallMangleArgs Empty => new FirewallMangleArgs();
    }

    public sealed class FirewallMangleState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// &lt;em&gt;Resource ID type (.id / name). This is an internal service field, setting a value is not required.&lt;/em&gt;
        /// </summary>
        ...
        public FirewallMangleState()
        {
        }
        public static new FirewallMangleState Empty => new FirewallMangleState();
    }
}
