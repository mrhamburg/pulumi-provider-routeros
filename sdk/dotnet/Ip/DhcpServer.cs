...
namespace Pulumi.Routeros.Ip
{
    ...
    /// </summary>
    [RouterosResourceType("routeros:Ip/dhcpServer:DhcpServer")]
    public partial class DhcpServer : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        public DhcpServer(string name, DhcpServerArgs args, CustomResourceOptions? options = null)
            : base("routeros:Ip/dhcpServer:DhcpServer", name, args ?? new DhcpServerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DhcpServer(string name, Input<string> id, DhcpServerState? state = null, CustomResourceOptions? options = null)
            : base("routeros:Ip/dhcpServer:DhcpServer", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static DhcpServer Get(string name, Input<string> id, DhcpServerState? state = null, CustomResourceOptions? options = null)
        {
            return new DhcpServer(name, id, state, options);
        }
    }

    public sealed class DhcpServerArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// &lt;em&gt;Resource ID type (.id / name). This is an internal service field, setting a value is not required.&lt;/em&gt;
        /// </summary>
        ...
        public DhcpServerArgs()
        {
        }
        public static new DhcpServerArgs Empty => new DhcpServerArgs();
    }

    public sealed class DhcpServerState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// &lt;em&gt;Resource ID type (.id / name). This is an internal service field, setting a value is not required.&lt;/em&gt;
        /// </summary>
        ...
        public DhcpServerState()
        {
        }
        public static new DhcpServerState Empty => new DhcpServerState();
    }
}
