...
namespace Pulumi.Routeros.Ip
{
    ...
    /// </summary>
    [RouterosResourceType("routeros:Ip/dnsRecord:DnsRecord")]
    public partial class DnsRecord : global::Pulumi.CustomResource
    {
        ...
        public DnsRecord(string name, DnsRecordArgs args, CustomResourceOptions? options = null)
            : base("routeros:Ip/dnsRecord:DnsRecord", name, args ?? new DnsRecordArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DnsRecord(string name, Input<string> id, DnsRecordState? state = null, CustomResourceOptions? options = null)
            : base("routeros:Ip/dnsRecord:DnsRecord", name, state, MakeResourceOptions(options, id))
        {
        }
