...
namespace Pulumi.Routeros.Ip
{
    ...
    /// ```
    /// </summary>
    [RouterosResourceType("routeros:Ip/ipFirewallFilter:IpFirewallFilter")]
    public partial class IpFirewallFilter : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        /// <summary>
        /// Create a IpFirewallFilter resource with the given unique name, arguments, and options.
        /// </summary>
        ///
        /// <param name="name">The unique name of the resource</param>
        /// <param name="args">The arguments used to populate this resource's properties</param>
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public IpFirewallFilter(string name, IpFirewallFilterArgs args, CustomResourceOptions? options = null)
            : base("routeros:Ip/ipFirewallFilter:IpFirewallFilter", name, args ?? new IpFirewallFilterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private IpFirewallFilter(string name, Input<string> id, IpFirewallFilterState? state = null, CustomResourceOptions? options = null)
            : base("routeros:Ip/ipFirewallFilter:IpFirewallFilter", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static IpFirewallFilter Get(string name, Input<string> id, IpFirewallFilterState? state = null, CustomResourceOptions? options = null)
        {
            return new IpFirewallFilter(name, id, state, options);
        }
    }

    public sealed class IpFirewallFilterArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// &lt;em&gt;Resource ID type (.id / name). This is an internal service field, setting a value is not required.&lt;/em&gt;
        /// </summary>
        ...
        public IpFirewallFilterArgs()
        {
        }
        public static new IpFirewallFilterArgs Empty => new IpFirewallFilterArgs();
    }

    public sealed class IpFirewallFilterState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// &lt;em&gt;Resource ID type (.id / name). This is an internal service field, setting a value is not required.&lt;/em&gt;
        /// </summary>
        ...
        public IpFirewallFilterState()
        {
        }
        public static new IpFirewallFilterState Empty => new IpFirewallFilterState();
    }
}
