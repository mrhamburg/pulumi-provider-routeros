...
{
    /// <summary>
    /// ## # routeros.Ip.DhcpClient (Resource)
    /// 
    /// ***
    /// 
    ...
    /// </summary>
    [RouterosResourceType("routeros:Ip/dhcpClient:DhcpClient")]
    public partial class DhcpClient : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        public DhcpClient(string name, DhcpClientArgs args, CustomResourceOptions? options = null)
            : base("routeros:Ip/dhcpClient:DhcpClient", name, args ?? new DhcpClientArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DhcpClient(string name, Input<string> id, DhcpClientState? state = null, CustomResourceOptions? options = null)
            : base("routeros:Ip/dhcpClient:DhcpClient", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static DhcpClient Get(string name, Input<string> id, DhcpClientState? state = null, CustomResourceOptions? options = null)
        {
            return new DhcpClient(name, id, state, options);
        }
    }

    public sealed class DhcpClientArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// &lt;em&gt;Resource ID type (.id / name). This is an internal service field, setting a value is not required.&lt;/em&gt;
        /// </summary>
        ...
        public DhcpClientArgs()
        {
        }
        public static new DhcpClientArgs Empty => new DhcpClientArgs();
    }

    public sealed class DhcpClientState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// &lt;em&gt;Resource ID type (.id / name). This is an internal service field, setting a value is not required.&lt;/em&gt;
        /// </summary>
        ...
        public DhcpClientState()
        {
        }
        public static new DhcpClientState Empty => new DhcpClientState();
    }
}
