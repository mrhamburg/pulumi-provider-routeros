...
namespace Pulumi.Routeros.Ip
{
    ...
    /// ```
    /// </summary>
    [RouterosResourceType("routeros:Ip/ipFirewallMangle:IpFirewallMangle")]
    public partial class IpFirewallMangle : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        public IpFirewallMangle(string name, IpFirewallMangleArgs args, CustomResourceOptions? options = null)
            : base("routeros:Ip/ipFirewallMangle:IpFirewallMangle", name, args ?? new IpFirewallMangleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private IpFirewallMangle(string name, Input<string> id, IpFirewallMangleState? state = null, CustomResourceOptions? options = null)
            : base("routeros:Ip/ipFirewallMangle:IpFirewallMangle", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static IpFirewallMangle Get(string name, Input<string> id, IpFirewallMangleState? state = null, CustomResourceOptions? options = null)
        {
            return new IpFirewallMangle(name, id, state, options);
        }
    }

    public sealed class IpFirewallMangleArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// &lt;em&gt;Resource ID type (.id / name). This is an internal service field, setting a value is not required.&lt;/em&gt;
        /// </summary>
        ...
        public IpFirewallMangleArgs()
        {
        }
        public static new IpFirewallMangleArgs Empty => new IpFirewallMangleArgs();
    }

    public sealed class IpFirewallMangleState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// &lt;em&gt;Resource ID type (.id / name). This is an internal service field, setting a value is not required.&lt;/em&gt;
        /// </summary>
        ...
        public IpFirewallMangleState()
        {
        }
        public static new IpFirewallMangleState Empty => new IpFirewallMangleState();
    }
}
