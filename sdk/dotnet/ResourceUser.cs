...
namespace Pulumi.Routeros
{
    ...
    /// {
    ///     var test = new Routeros.ResourceUser("test", new()
    ///     {
    ///         Address = "0.0.0.0/0",
    ///         Comment = "Test User",
    ///         Group = "read",
    ...
    /// ```
    /// </summary>
    [RouterosResourceType("routeros:index/resourceUser:ResourceUser")]
    public partial class ResourceUser : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        public ResourceUser(string name, ResourceUserArgs args, CustomResourceOptions? options = null)
            : base("routeros:index/resourceUser:ResourceUser", name, args ?? new ResourceUserArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ResourceUser(string name, Input<string> id, ResourceUserState? state = null, CustomResourceOptions? options = null)
            : base("routeros:index/resourceUser:ResourceUser", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static ResourceUser Get(string name, Input<string> id, ResourceUserState? state = null, CustomResourceOptions? options = null)
        {
            return new ResourceUser(name, id, state, options);
        }
    }

    public sealed class ResourceUserArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// &lt;em&gt;Resource ID type (.id / name). This is an internal service field, setting a value is not required.&lt;/em&gt;
        /// </summary>
        ...
        public ResourceUserArgs()
        {
        }
        public static new ResourceUserArgs Empty => new ResourceUserArgs();
    }

    public sealed class ResourceUserState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// &lt;em&gt;Resource ID type (.id / name). This is an internal service field, setting a value is not required.&lt;/em&gt;
        /// </summary>
        ...
        public ResourceUserState()
        {
        }
        public static new ResourceUserState Empty => new ResourceUserState();
    }
}
