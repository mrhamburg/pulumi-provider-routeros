...
{
    /// <summary>
    /// ## # routeros.Iface.Wireguard (Resource)
    /// 
    /// ***
    /// 
    ...
    /// </summary>
    [RouterosResourceType("routeros:Iface/wireguard:Wireguard")]
    public partial class Wireguard : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        public Wireguard(string name, WireguardArgs args, CustomResourceOptions? options = null)
            : base("routeros:Iface/wireguard:Wireguard", name, args ?? new WireguardArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Wireguard(string name, Input<string> id, WireguardState? state = null, CustomResourceOptions? options = null)
            : base("routeros:Iface/wireguard:Wireguard", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static Wireguard Get(string name, Input<string> id, WireguardState? state = null, CustomResourceOptions? options = null)
        {
            return new Wireguard(name, id, state, options);
        }
    }

    public sealed class WireguardArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// &lt;em&gt;Resource ID type (.id / name). This is an internal service field, setting a value is not required.&lt;/em&gt;
        /// </summary>
        ...
        public WireguardArgs()
        {
        }
        public static new WireguardArgs Empty => new WireguardArgs();
    }

    public sealed class WireguardState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// &lt;em&gt;Resource ID type (.id / name). This is an internal service field, setting a value is not required.&lt;/em&gt;
        /// </summary>
        ...
        public WireguardState()
        {
        }
        public static new WireguardState Empty => new WireguardState();
    }
}
