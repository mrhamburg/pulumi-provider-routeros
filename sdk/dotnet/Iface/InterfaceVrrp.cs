...
namespace Pulumi.Routeros.Iface
{
    ...
    /// ```
    /// </summary>
    [RouterosResourceType("routeros:Iface/interfaceVrrp:InterfaceVrrp")]
    public partial class InterfaceVrrp : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        public InterfaceVrrp(string name, InterfaceVrrpArgs args, CustomResourceOptions? options = null)
            : base("routeros:Iface/interfaceVrrp:InterfaceVrrp", name, args ?? new InterfaceVrrpArgs(), MakeResourceOptions(options, ""))
        {
        }

        private InterfaceVrrp(string name, Input<string> id, InterfaceVrrpState? state = null, CustomResourceOptions? options = null)
            : base("routeros:Iface/interfaceVrrp:InterfaceVrrp", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static InterfaceVrrp Get(string name, Input<string> id, InterfaceVrrpState? state = null, CustomResourceOptions? options = null)
        {
            return new InterfaceVrrp(name, id, state, options);
        }
    }
    ...
    public sealed class InterfaceVrrpState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// &lt;em&gt;Resource ID type (.id / name). This is an internal service field, setting a value is not required.&lt;/em&gt;
        /// </summary>
        ...
        public InterfaceVrrpState()
        {
        }
        public static new InterfaceVrrpState Empty => new InterfaceVrrpState();
    }
}
