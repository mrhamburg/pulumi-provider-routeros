...
namespace Pulumi.Routeros.Ipv6
{
    ...
    /// ```
    /// </summary>
    [RouterosResourceType("routeros:Ipv6/firewallFilter:FirewallFilter")]
    public partial class FirewallFilter : global::Pulumi.CustomResource
    {
        ...
        public FirewallFilter(string name, FirewallFilterArgs args, CustomResourceOptions? options = null)
            : base("routeros:Ipv6/firewallFilter:FirewallFilter", name, args ?? new FirewallFilterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private FirewallFilter(string name, Input<string> id, FirewallFilterState? state = null, CustomResourceOptions? options = null)
            : base("routeros:Ipv6/firewallFilter:FirewallFilter", name, state, MakeResourceOptions(options, id))
        {
        }
