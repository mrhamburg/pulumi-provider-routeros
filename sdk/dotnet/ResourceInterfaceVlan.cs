...
namespace Pulumi.Routeros
{
    ...
    /// {
    ///     var interfaceVlan = new Routeros.ResourceInterfaceVlan("interfaceVlan", new()
    ///     {
    ///         Interface = "bridge",
    ///         VlanId = 50,
    ///     });
    ...
    /// ```
    /// </summary>
    [RouterosResourceType("routeros:index/resourceInterfaceVlan:ResourceInterfaceVlan")]
    public partial class ResourceInterfaceVlan : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        /// <summary>
        /// Create a ResourceInterfaceVlan resource with the given unique name, arguments, and options.
        /// </summary>
        ///
        /// <param name="name">The unique name of the resource</param>
        /// <param name="args">The arguments used to populate this resource's properties</param>
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public ResourceInterfaceVlan(string name, ResourceInterfaceVlanArgs args, CustomResourceOptions? options = null)
            : base("routeros:index/resourceInterfaceVlan:ResourceInterfaceVlan", name, args ?? new ResourceInterfaceVlanArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ResourceInterfaceVlan(string name, Input<string> id, ResourceInterfaceVlanState? state = null, CustomResourceOptions? options = null)
            : base("routeros:index/resourceInterfaceVlan:ResourceInterfaceVlan", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static ResourceInterfaceVlan Get(string name, Input<string> id, ResourceInterfaceVlanState? state = null, CustomResourceOptions? options = null)
        {
            return new ResourceInterfaceVlan(name, id, state, options);
        }
    }

    public sealed class ResourceInterfaceVlanArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// &lt;em&gt;Resource ID type (.id / name). This is an internal service field, setting a value is not required.&lt;/em&gt;
        /// </summary>
        ...
        public ResourceInterfaceVlanArgs()
        {
        }
        public static new ResourceInterfaceVlanArgs Empty => new ResourceInterfaceVlanArgs();
    }

    public sealed class ResourceInterfaceVlanState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// &lt;em&gt;Resource ID type (.id / name). This is an internal service field, setting a value is not required.&lt;/em&gt;
        /// </summary>
        ...
        public ResourceInterfaceVlanState()
        {
        }
        public static new ResourceInterfaceVlanState Empty => new ResourceInterfaceVlanState();
    }
}
