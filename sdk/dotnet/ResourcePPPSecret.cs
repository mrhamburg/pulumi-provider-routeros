...
namespace Pulumi.Routeros
{
    ...
    /// {
    ///     var test = new Routeros.ResourcePPPSecret("test", new()
    ///     {
    ///         Password = "123",
    ///         Profile = "default",
    ///     });
    ...
    /// ```
    /// </summary>
    [RouterosResourceType("routeros:index/resourcePPPSecret:ResourcePPPSecret")]
    public partial class ResourcePPPSecret : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        /// <summary>
        /// Create a ResourcePPPSecret resource with the given unique name, arguments, and options.
        /// </summary>
        ///
        /// <param name="name">The unique name of the resource</param>
        /// <param name="args">The arguments used to populate this resource's properties</param>
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public ResourcePPPSecret(string name, ResourcePPPSecretArgs? args = null, CustomResourceOptions? options = null)
            : base("routeros:index/resourcePPPSecret:ResourcePPPSecret", name, args ?? new ResourcePPPSecretArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ResourcePPPSecret(string name, Input<string> id, ResourcePPPSecretState? state = null, CustomResourceOptions? options = null)
            : base("routeros:index/resourcePPPSecret:ResourcePPPSecret", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <summary>
        /// Get an existing ResourcePPPSecret resource's state with the given name, ID, and optional extra
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static ResourcePPPSecret Get(string name, Input<string> id, ResourcePPPSecretState? state = null, CustomResourceOptions? options = null)
        {
            return new ResourcePPPSecret(name, id, state, options);
        }
    }

    public sealed class ResourcePPPSecretArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// &lt;em&gt;Resource ID type (.id / name). This is an internal service field, setting a value is not required.&lt;/em&gt;
        /// </summary>
        ...
        public ResourcePPPSecretArgs()
        {
        }
        public static new ResourcePPPSecretArgs Empty => new ResourcePPPSecretArgs();
    }

    public sealed class ResourcePPPSecretState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// &lt;em&gt;Resource ID type (.id / name). This is an internal service field, setting a value is not required.&lt;/em&gt;
        /// </summary>
        ...
        public ResourcePPPSecretState()
        {
        }
        public static new ResourcePPPSecretState Empty => new ResourcePPPSecretState();
    }
}
