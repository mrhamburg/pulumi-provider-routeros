...
namespace Pulumi.Routeros
{
    ...
    /// {
    ///     var ipv6Address = new Routeros.ResourceIPv6Address("ipv6Address", new()
    ///     {
    ///         Address = "fd55::1/64",
    ///         Disabled = false,
    ///         Interface = "ether1",
    ...
    /// ```
    /// </summary>
    [RouterosResourceType("routeros:index/resourceIPv6Address:ResourceIPv6Address")]
    public partial class ResourceIPv6Address : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        public ResourceIPv6Address(string name, ResourceIPv6AddressArgs args, CustomResourceOptions? options = null)
            : base("routeros:index/resourceIPv6Address:ResourceIPv6Address", name, args ?? new ResourceIPv6AddressArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ResourceIPv6Address(string name, Input<string> id, ResourceIPv6AddressState? state = null, CustomResourceOptions? options = null)
            : base("routeros:index/resourceIPv6Address:ResourceIPv6Address", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static ResourceIPv6Address Get(string name, Input<string> id, ResourceIPv6AddressState? state = null, CustomResourceOptions? options = null)
        {
            return new ResourceIPv6Address(name, id, state, options);
        }
    }

    public sealed class ResourceIPv6AddressArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// &lt;em&gt;Resource ID type (.id / name). This is an internal service field, setting a value is not required.&lt;/em&gt;
        /// </summary>
        ...
        public ResourceIPv6AddressArgs()
        {
        }
        public static new ResourceIPv6AddressArgs Empty => new ResourceIPv6AddressArgs();
    }

    public sealed class ResourceIPv6AddressState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// &lt;em&gt;Resource ID type (.id / name). This is an internal service field, setting a value is not required.&lt;/em&gt;
        /// </summary>
        ...
        public ResourceIPv6AddressState()
        {
        }
        public static new ResourceIPv6AddressState Empty => new ResourceIPv6AddressState();
    }
}
