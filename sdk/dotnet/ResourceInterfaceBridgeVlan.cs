...
namespace Pulumi.Routeros
{
    ...
    /// {
    ///     var bridgeVlan = new Routeros.ResourceInterfaceBridgeVlan("bridgeVlan", new()
    ///     {
    ///         Bridge = "bridge",
    ///         Taggeds = new[]
    ///         {
    ...
    /// ```
    /// </summary>
    [RouterosResourceType("routeros:index/resourceInterfaceBridgeVlan:ResourceInterfaceBridgeVlan")]
    public partial class ResourceInterfaceBridgeVlan : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        /// <summary>
        /// Create a ResourceInterfaceBridgeVlan resource with the given unique name, arguments, and options.
        /// </summary>
        ///
        /// <param name="name">The unique name of the resource</param>
        /// <param name="args">The arguments used to populate this resource's properties</param>
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public ResourceInterfaceBridgeVlan(string name, ResourceInterfaceBridgeVlanArgs args, CustomResourceOptions? options = null)
            : base("routeros:index/resourceInterfaceBridgeVlan:ResourceInterfaceBridgeVlan", name, args ?? new ResourceInterfaceBridgeVlanArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ResourceInterfaceBridgeVlan(string name, Input<string> id, ResourceInterfaceBridgeVlanState? state = null, CustomResourceOptions? options = null)
            : base("routeros:index/resourceInterfaceBridgeVlan:ResourceInterfaceBridgeVlan", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <summary>
        /// Get an existing ResourceInterfaceBridgeVlan resource's state with the given name, ID, and optional extra
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static ResourceInterfaceBridgeVlan Get(string name, Input<string> id, ResourceInterfaceBridgeVlanState? state = null, CustomResourceOptions? options = null)
        {
            return new ResourceInterfaceBridgeVlan(name, id, state, options);
        }
    }

    public sealed class ResourceInterfaceBridgeVlanArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// &lt;em&gt;Resource ID type (.id / name). This is an internal service field, setting a value is not required.&lt;/em&gt;
        /// </summary>
        ...
        public ResourceInterfaceBridgeVlanArgs()
        {
        }
        public static new ResourceInterfaceBridgeVlanArgs Empty => new ResourceInterfaceBridgeVlanArgs();
    }

    public sealed class ResourceInterfaceBridgeVlanState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// &lt;em&gt;Resource ID type (.id / name). This is an internal service field, setting a value is not required.&lt;/em&gt;
        /// </summary>
        ...
        public ResourceInterfaceBridgeVlanState()
        {
        }
        public static new ResourceInterfaceBridgeVlanState Empty => new ResourceInterfaceBridgeVlanState();
    }
}
