 ...
 * ```
 */
export class ResourceCapsManRates extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ResourceCapsManRatesState, opts?: pulumi.CustomResourceOptions): ResourceCapsManRates {
        return new ResourceCapsManRates(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'routeros:index/resourceCapsManRates:ResourceCapsManRates';

    /**
     * Returns true if the given object is an instance of ResourceCapsManRates.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is ResourceCapsManRates {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === ResourceCapsManRates.__pulumiType;
    }
     ...
     */
    constructor(name: string, args?: ResourceCapsManRatesArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: ResourceCapsManRatesArgs | ResourceCapsManRatesState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as ResourceCapsManRatesState | undefined;
            ...
            const args = argsOrState as ResourceCapsManRatesArgs | undefined;
        ...
        super(ResourceCapsManRates.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface ResourceCapsManRatesState {
    /**
     * <em>Resource ID type (.id / name). This is an internal service field, setting a value is not required.</em>
     */
 ...
 */
export interface ResourceCapsManRatesArgs {
    /**
     * <em>Resource ID type (.id / name). This is an internal service field, setting a value is not required.</em>
     */
    ___id_?: pulumi.Input<number>;
