 ...
 * ```
 */
export class V6Address extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: V6AddressState, opts?: pulumi.CustomResourceOptions): V6Address {
        return new V6Address(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'routeros:Ipv6/v6Address:V6Address';

    /**
     * Returns true if the given object is an instance of V6Address.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is V6Address {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === V6Address.__pulumiType;
    }
     ...
     */
    constructor(name: string, args: V6AddressArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: V6AddressArgs | V6AddressState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as V6AddressState | undefined;
            ...
            const args = argsOrState as V6AddressArgs | undefined;
        ...
        super(V6Address.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface V6AddressState {
    /**
     * <em>Resource ID type (.id / name). This is an internal service field, setting a value is not required.</em>
     */
 ...
 */
export interface V6AddressArgs {
    /**
     * <em>Resource ID type (.id / name). This is an internal service field, setting a value is not required.</em>
     */
    ___id_?: pulumi.Input<number>;
