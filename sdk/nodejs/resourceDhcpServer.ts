 ...
 *
 * const server = new routeros.ResourceDhcpServer("server", {
 ...
 * ```
 */
export class ResourceDhcpServer extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ResourceDhcpServerState, opts?: pulumi.CustomResourceOptions): ResourceDhcpServer {
        return new ResourceDhcpServer(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'routeros:index/resourceDhcpServer:ResourceDhcpServer';

    /**
     * Returns true if the given object is an instance of ResourceDhcpServer.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is ResourceDhcpServer {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === ResourceDhcpServer.__pulumiType;
    }
     ...
     */
    constructor(name: string, args: ResourceDhcpServerArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: ResourceDhcpServerArgs | ResourceDhcpServerState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as ResourceDhcpServerState | undefined;
            ...
            const args = argsOrState as ResourceDhcpServerArgs | undefined;
        ...
        super(ResourceDhcpServer.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface ResourceDhcpServerState {
    /**
     * <em>Resource ID type (.id / name). This is an internal service field, setting a value is not required.</em>
     */
 ...
 */
export interface ResourceDhcpServerArgs {
    /**
     * <em>Resource ID type (.id / name). This is an internal service field, setting a value is not required.</em>
     */
    ___id_?: pulumi.Input<number>;
