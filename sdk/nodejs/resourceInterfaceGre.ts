 ...
 *
 * const greHq = new routeros.ResourceInterfaceGre("greHq", {
 *     disabled: true,
 ...
 * ```
 */
export class ResourceInterfaceGre extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ResourceInterfaceGreState, opts?: pulumi.CustomResourceOptions): ResourceInterfaceGre {
        return new ResourceInterfaceGre(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'routeros:index/resourceInterfaceGre:ResourceInterfaceGre';

    /**
     * Returns true if the given object is an instance of ResourceInterfaceGre.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is ResourceInterfaceGre {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === ResourceInterfaceGre.__pulumiType;
    }
     ...
     */
    constructor(name: string, args: ResourceInterfaceGreArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: ResourceInterfaceGreArgs | ResourceInterfaceGreState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as ResourceInterfaceGreState | undefined;
            ...
            const args = argsOrState as ResourceInterfaceGreArgs | undefined;
        ...
        super(ResourceInterfaceGre.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface ResourceInterfaceGreState {
    /**
     * <em>Resource ID type (.id / name). This is an internal service field, setting a value is not required.</em>
     */
 ...
 */
export interface ResourceInterfaceGreArgs {
    /**
     * <em>Resource ID type (.id / name). This is an internal service field, setting a value is not required.</em>
     */
    ___id_?: pulumi.Input<number>;
