 ...
 *
 * const dhcpServerNetwork = new routeros.ResourceDhcpServerNetwork("dhcpServerNetwork", {
 *     address: "10.0.0.0/24",
 *     dnsServer: "1.1.1.1",
 *     gateway: "10.0.0.1",
 * });
 ...
 * ```
 */
export class ResourceDhcpServerNetwork extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ResourceDhcpServerNetworkState, opts?: pulumi.CustomResourceOptions): ResourceDhcpServerNetwork {
        return new ResourceDhcpServerNetwork(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'routeros:index/resourceDhcpServerNetwork:ResourceDhcpServerNetwork';

    /**
     * Returns true if the given object is an instance of ResourceDhcpServerNetwork.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is ResourceDhcpServerNetwork {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === ResourceDhcpServerNetwork.__pulumiType;
    }
     ...
     */
    constructor(name: string, args: ResourceDhcpServerNetworkArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: ResourceDhcpServerNetworkArgs | ResourceDhcpServerNetworkState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as ResourceDhcpServerNetworkState | undefined;
            ...
            const args = argsOrState as ResourceDhcpServerNetworkArgs | undefined;
        ...
        super(ResourceDhcpServerNetwork.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface ResourceDhcpServerNetworkState {
    /**
     * <em>Resource ID type (.id / name). This is an internal service field, setting a value is not required.</em>
     */
 ...
 */
export interface ResourceDhcpServerNetworkArgs {
    /**
     * <em>Resource ID type (.id / name). This is an internal service field, setting a value is not required.</em>
     */
    ___id_?: pulumi.Input<number>;
