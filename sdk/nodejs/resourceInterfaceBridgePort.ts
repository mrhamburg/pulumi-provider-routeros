 ...
 *
 * const bridgePort = new routeros.ResourceInterfaceBridgePort("bridgePort", {
 *     bridge: "bridge",
 *     "interface": "ether5",
 *     pvid: 50,
 * });
 ...
 * ```
 */
export class ResourceInterfaceBridgePort extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ResourceInterfaceBridgePortState, opts?: pulumi.CustomResourceOptions): ResourceInterfaceBridgePort {
        return new ResourceInterfaceBridgePort(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'routeros:index/resourceInterfaceBridgePort:ResourceInterfaceBridgePort';

    /**
     * Returns true if the given object is an instance of ResourceInterfaceBridgePort.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is ResourceInterfaceBridgePort {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === ResourceInterfaceBridgePort.__pulumiType;
    }
     ...
     */
    constructor(name: string, args: ResourceInterfaceBridgePortArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: ResourceInterfaceBridgePortArgs | ResourceInterfaceBridgePortState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as ResourceInterfaceBridgePortState | undefined;
            ...
            const args = argsOrState as ResourceInterfaceBridgePortArgs | undefined;
        ...
        super(ResourceInterfaceBridgePort.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface ResourceInterfaceBridgePortState {
    /**
     * <em>Resource ID type (.id / name). This is an internal service field, setting a value is not required.</em>
     */
 ...
 */
export interface ResourceInterfaceBridgePortArgs {
    /**
     * <em>Resource ID type (.id / name). This is an internal service field, setting a value is not required.</em>
     */
    ___id_?: pulumi.Input<number>;
