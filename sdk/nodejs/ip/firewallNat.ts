 ...
 */
export class FirewallNat extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: FirewallNatState, opts?: pulumi.CustomResourceOptions): FirewallNat {
        return new FirewallNat(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'routeros:Ip/firewallNat:FirewallNat';

    /**
     * Returns true if the given object is an instance of FirewallNat.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is FirewallNat {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === FirewallNat.__pulumiType;
    }
     ...
     */
    constructor(name: string, args: FirewallNatArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: FirewallNatArgs | FirewallNatState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as FirewallNatState | undefined;
            ...
            const args = argsOrState as FirewallNatArgs | undefined;
        ...
        super(FirewallNat.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface FirewallNatState {
    /**
     * <em>Resource ID type (.id / name). This is an internal service field, setting a value is not required.</em>
     */
 ...
 */
export interface FirewallNatArgs {
    /**
     * <em>Resource ID type (.id / name). This is an internal service field, setting a value is not required.</em>
     */
    ___id_?: pulumi.Input<number>;
