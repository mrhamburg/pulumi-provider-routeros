 ...
 * ```
 */
export class DhcpIpServer extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DhcpIpServerState, opts?: pulumi.CustomResourceOptions): DhcpIpServer {
        return new DhcpIpServer(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'routeros:Ip/dhcpIpServer:DhcpIpServer';

    /**
     * Returns true if the given object is an instance of DhcpIpServer.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is DhcpIpServer {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === DhcpIpServer.__pulumiType;
    }
     ...
     */
    constructor(name: string, args: DhcpIpServerArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: DhcpIpServerArgs | DhcpIpServerState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as DhcpIpServerState | undefined;
            ...
            const args = argsOrState as DhcpIpServerArgs | undefined;
        ...
        super(DhcpIpServer.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface DhcpIpServerState {
    /**
     * <em>Resource ID type (.id / name). This is an internal service field, setting a value is not required.</em>
     */
 ...
 */
export interface DhcpIpServerArgs {
    /**
     * <em>Resource ID type (.id / name). This is an internal service field, setting a value is not required.</em>
     */
    ___id_?: pulumi.Input<number>;
