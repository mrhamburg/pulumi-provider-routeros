 ...
 * ```
 */
export class DhcpIpServerLease extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DhcpIpServerLeaseState, opts?: pulumi.CustomResourceOptions): DhcpIpServerLease {
        return new DhcpIpServerLease(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'routeros:Ip/dhcpIpServerLease:DhcpIpServerLease';

    /**
     * Returns true if the given object is an instance of DhcpIpServerLease.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is DhcpIpServerLease {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === DhcpIpServerLease.__pulumiType;
    }
     ...
     */
    constructor(name: string, args: DhcpIpServerLeaseArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: DhcpIpServerLeaseArgs | DhcpIpServerLeaseState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as DhcpIpServerLeaseState | undefined;
            ...
            const args = argsOrState as DhcpIpServerLeaseArgs | undefined;
        ...
        super(DhcpIpServerLease.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface DhcpIpServerLeaseState {
    /**
     * <em>Resource ID type (.id / name). This is an internal service field, setting a value is not required.</em>
     */
 ...
 */
export interface DhcpIpServerLeaseArgs {
    /**
     * <em>Resource ID type (.id / name). This is an internal service field, setting a value is not required.</em>
     */
    ___id_?: pulumi.Input<number>;
