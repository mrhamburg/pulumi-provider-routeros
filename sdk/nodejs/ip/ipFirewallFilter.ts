 ...
 * ```
 */
export class IpFirewallFilter extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: IpFirewallFilterState, opts?: pulumi.CustomResourceOptions): IpFirewallFilter {
        return new IpFirewallFilter(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'routeros:Ip/ipFirewallFilter:IpFirewallFilter';

    /**
     * Returns true if the given object is an instance of IpFirewallFilter.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is IpFirewallFilter {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === IpFirewallFilter.__pulumiType;
    }
     ...
     */
    constructor(name: string, args: IpFirewallFilterArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: IpFirewallFilterArgs | IpFirewallFilterState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as IpFirewallFilterState | undefined;
            ...
            const args = argsOrState as IpFirewallFilterArgs | undefined;
        ...
        super(IpFirewallFilter.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface IpFirewallFilterState {
    /**
     * <em>Resource ID type (.id / name). This is an internal service field, setting a value is not required.</em>
     */
 ...
 */
export interface IpFirewallFilterArgs {
    /**
     * <em>Resource ID type (.id / name). This is an internal service field, setting a value is not required.</em>
     */
    ___id_?: pulumi.Input<number>;
