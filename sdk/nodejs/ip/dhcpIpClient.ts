 ...
 * ```
 */
export class DhcpIpClient extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DhcpIpClientState, opts?: pulumi.CustomResourceOptions): DhcpIpClient {
        return new DhcpIpClient(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'routeros:Ip/dhcpIpClient:DhcpIpClient';

    /**
     * Returns true if the given object is an instance of DhcpIpClient.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is DhcpIpClient {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === DhcpIpClient.__pulumiType;
    }
     ...
     */
    constructor(name: string, args: DhcpIpClientArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: DhcpIpClientArgs | DhcpIpClientState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as DhcpIpClientState | undefined;
            ...
            const args = argsOrState as DhcpIpClientArgs | undefined;
        ...
        super(DhcpIpClient.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface DhcpIpClientState {
    /**
     * <em>Resource ID type (.id / name). This is an internal service field, setting a value is not required.</em>
     */
 ...
 */
export interface DhcpIpClientArgs {
    /**
     * <em>Resource ID type (.id / name). This is an internal service field, setting a value is not required.</em>
     */
    ___id_?: pulumi.Input<number>;
