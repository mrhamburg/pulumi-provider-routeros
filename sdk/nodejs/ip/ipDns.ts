 ...
 */
export class IpDns extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: IpDnsState, opts?: pulumi.CustomResourceOptions): IpDns {
        return new IpDns(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'routeros:Ip/ipDns:IpDns';

    /**
     * Returns true if the given object is an instance of IpDns.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is IpDns {
     ...
     */
    constructor(name: string, args?: IpDnsArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: IpDnsArgs | IpDnsState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as IpDnsState | undefined;
            ...
            const args = argsOrState as IpDnsArgs | undefined;
        ...
        super(IpDns.__pulumiType, name, resourceInputs, opts);
    }
}
