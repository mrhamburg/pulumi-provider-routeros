 ...
 * ```
 */
export class IpFirewallMangle extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: IpFirewallMangleState, opts?: pulumi.CustomResourceOptions): IpFirewallMangle {
        return new IpFirewallMangle(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'routeros:Ip/ipFirewallMangle:IpFirewallMangle';

    /**
     * Returns true if the given object is an instance of IpFirewallMangle.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is IpFirewallMangle {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === IpFirewallMangle.__pulumiType;
    }
    ...
    /**
     * Create a IpFirewallMangle resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: IpFirewallMangleArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: IpFirewallMangleArgs | IpFirewallMangleState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as IpFirewallMangleState | undefined;
            ...
            const args = argsOrState as IpFirewallMangleArgs | undefined;
        ...
        super(IpFirewallMangle.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface IpFirewallMangleState {
    /**
     * <em>Resource ID type (.id / name). This is an internal service field, setting a value is not required.</em>
     */
 ...
 */
export interface IpFirewallMangleArgs {
    /**
     * <em>Resource ID type (.id / name). This is an internal service field, setting a value is not required.</em>
     */
    ___id_?: pulumi.Input<number>;
