 ...
 */
export class DhcpClient extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DhcpClientState, opts?: pulumi.CustomResourceOptions): DhcpClient {
        return new DhcpClient(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'routeros:Ip/dhcpClient:DhcpClient';

    /**
     * Returns true if the given object is an instance of DhcpClient.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is DhcpClient {
    ...
    constructor(name: string, argsOrState?: DhcpClientArgs | DhcpClientState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as DhcpClientState | undefined;
            ...
            const args = argsOrState as DhcpClientArgs | undefined;
        ...
        super(DhcpClient.__pulumiType, name, resourceInputs, opts);
    }
}
