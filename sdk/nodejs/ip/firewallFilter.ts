 ...
 */
export class FirewallFilter extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: FirewallFilterState, opts?: pulumi.CustomResourceOptions): FirewallFilter {
        return new FirewallFilter(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'routeros:Ip/firewallFilter:FirewallFilter';

    /**
     * Returns true if the given object is an instance of FirewallFilter.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is FirewallFilter {
    ...
    constructor(name: string, argsOrState?: FirewallFilterArgs | FirewallFilterState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as FirewallFilterState | undefined;
            ...
            const args = argsOrState as FirewallFilterArgs | undefined;
        ...
        super(FirewallFilter.__pulumiType, name, resourceInputs, opts);
    }
}
