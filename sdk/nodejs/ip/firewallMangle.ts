...
/**
 * ## # routeros.Ip.FirewallMangle (Resource)
 *
 * ***
 *
 ...
 */
export class FirewallMangle extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: FirewallMangleState, opts?: pulumi.CustomResourceOptions): FirewallMangle {
        return new FirewallMangle(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'routeros:Ip/firewallMangle:FirewallMangle';

    /**
     * Returns true if the given object is an instance of FirewallMangle.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is FirewallMangle {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === FirewallMangle.__pulumiType;
    }
    ...
    /**
     * Create a FirewallMangle resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: FirewallMangleArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: FirewallMangleArgs | FirewallMangleState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as FirewallMangleState | undefined;
            ...
            const args = argsOrState as FirewallMangleArgs | undefined;
        ...
        super(FirewallMangle.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface FirewallMangleState {
    /**
     * <em>Resource ID type (.id / name). This is an internal service field, setting a value is not required.</em>
     */
 ...
 */
export interface FirewallMangleArgs {
    /**
     * <em>Resource ID type (.id / name). This is an internal service field, setting a value is not required.</em>
     */
    ___id_?: pulumi.Input<number>;
