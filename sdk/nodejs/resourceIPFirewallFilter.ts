 ...
 *
 * const rule = new routeros.ResourceIPFirewallFilter("rule", {
 *     action: "accept",
 *     chain: "forward",
 *     dstAddress: "10.0.1.1",
 *     dstPort: "443",
 ...
 * ```
 */
export class ResourceIPFirewallFilter extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ResourceIPFirewallFilterState, opts?: pulumi.CustomResourceOptions): ResourceIPFirewallFilter {
        return new ResourceIPFirewallFilter(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'routeros:index/resourceIPFirewallFilter:ResourceIPFirewallFilter';

    /**
     * Returns true if the given object is an instance of ResourceIPFirewallFilter.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is ResourceIPFirewallFilter {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === ResourceIPFirewallFilter.__pulumiType;
    }
     ...
     */
    public readonly hwOffload!: pulumi.Output<boolean | undefined>;
    /**
     ...
     */
    public readonly rejectWith!: pulumi.Output<string | undefined>;
    /**
     ...
     */
    constructor(name: string, args: ResourceIPFirewallFilterArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: ResourceIPFirewallFilterArgs | ResourceIPFirewallFilterState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as ResourceIPFirewallFilterState | undefined;
            ...
            const args = argsOrState as ResourceIPFirewallFilterArgs | undefined;
        ...
        super(ResourceIPFirewallFilter.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface ResourceIPFirewallFilterState {
    /**
     * <em>Resource ID type (.id / name). This is an internal service field, setting a value is not required.</em>
     */
 ...
 */
export interface ResourceIPFirewallFilterArgs {
    /**
     * <em>Resource ID type (.id / name). This is an internal service field, setting a value is not required.</em>
     */
    ___id_?: pulumi.Input<number>;
