 ...
 * ```
 */
export class Datapath extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DatapathState, opts?: pulumi.CustomResourceOptions): Datapath {
        return new Datapath(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'routeros:CapsMan/datapath:Datapath';

    /**
     * Returns true if the given object is an instance of Datapath.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is Datapath {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === Datapath.__pulumiType;
    }
     ...
     */
    constructor(name: string, args?: DatapathArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: DatapathArgs | DatapathState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as DatapathState | undefined;
            ...
            const args = argsOrState as DatapathArgs | undefined;
        ...
        super(Datapath.__pulumiType, name, resourceInputs, opts);
    }
}
