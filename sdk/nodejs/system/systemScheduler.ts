 ...
 * ```
 */
export class SystemScheduler extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SystemSchedulerState, opts?: pulumi.CustomResourceOptions): SystemScheduler {
        return new SystemScheduler(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'routeros:System/systemScheduler:SystemScheduler';

    /**
     * Returns true if the given object is an instance of SystemScheduler.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is SystemScheduler {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === SystemScheduler.__pulumiType;
    }
    ...
    constructor(name: string, argsOrState?: SystemSchedulerArgs | SystemSchedulerState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as SystemSchedulerState | undefined;
            ...
            const args = argsOrState as SystemSchedulerArgs | undefined;
        ...
        super(SystemScheduler.__pulumiType, name, resourceInputs, opts);
    }
}
