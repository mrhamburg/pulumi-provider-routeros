 ...
 * const wgPeer = new routeros.ResourceInterfaceWireguardPeer("wgPeer", {
 ...
 * ```
 */
export class ResourceInterfaceWireguardPeer extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ResourceInterfaceWireguardPeerState, opts?: pulumi.CustomResourceOptions): ResourceInterfaceWireguardPeer {
        return new ResourceInterfaceWireguardPeer(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'routeros:index/resourceInterfaceWireguardPeer:ResourceInterfaceWireguardPeer';

    /**
     * Returns true if the given object is an instance of ResourceInterfaceWireguardPeer.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is ResourceInterfaceWireguardPeer {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === ResourceInterfaceWireguardPeer.__pulumiType;
    }
     ...
     */
    constructor(name: string, args: ResourceInterfaceWireguardPeerArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: ResourceInterfaceWireguardPeerArgs | ResourceInterfaceWireguardPeerState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as ResourceInterfaceWireguardPeerState | undefined;
            ...
            const args = argsOrState as ResourceInterfaceWireguardPeerArgs | undefined;
        ...
        super(ResourceInterfaceWireguardPeer.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface ResourceInterfaceWireguardPeerState {
    /**
     * <em>Resource ID type (.id / name). This is an internal service field, setting a value is not required.</em>
     */
 ...
 */
export interface ResourceInterfaceWireguardPeerArgs {
    /**
     * <em>Resource ID type (.id / name). This is an internal service field, setting a value is not required.</em>
     */
    ___id_?: pulumi.Input<number>;
