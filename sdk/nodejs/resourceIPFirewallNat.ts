 ...
 *
 * const rule = new routeros.ResourceIPFirewallNat("rule", {
 *     action: "masquerade",
 *     chain: "srcnat",
 ...
 * ```
 */
export class ResourceIPFirewallNat extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ResourceIPFirewallNatState, opts?: pulumi.CustomResourceOptions): ResourceIPFirewallNat {
        return new ResourceIPFirewallNat(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'routeros:index/resourceIPFirewallNat:ResourceIPFirewallNat';

    /**
     * Returns true if the given object is an instance of ResourceIPFirewallNat.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is ResourceIPFirewallNat {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === ResourceIPFirewallNat.__pulumiType;
    }
     ...
     */
    constructor(name: string, args: ResourceIPFirewallNatArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: ResourceIPFirewallNatArgs | ResourceIPFirewallNatState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as ResourceIPFirewallNatState | undefined;
            ...
            const args = argsOrState as ResourceIPFirewallNatArgs | undefined;
        ...
        super(ResourceIPFirewallNat.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface ResourceIPFirewallNatState {
    /**
     * <em>Resource ID type (.id / name). This is an internal service field, setting a value is not required.</em>
     */
 ...
 */
export interface ResourceIPFirewallNatArgs {
    /**
     * <em>Resource ID type (.id / name). This is an internal service field, setting a value is not required.</em>
     */
    ___id_?: pulumi.Input<number>;
