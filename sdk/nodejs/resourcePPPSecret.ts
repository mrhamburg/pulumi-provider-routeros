 ...
 *
 * const test = new routeros.ResourcePPPSecret("test", {
 *     password: "123",
 *     profile: "default",
 * });
 * ```
 ...
 * ```
 */
export class ResourcePPPSecret extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ResourcePPPSecretState, opts?: pulumi.CustomResourceOptions): ResourcePPPSecret {
        return new ResourcePPPSecret(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'routeros:index/resourcePPPSecret:ResourcePPPSecret';

    /**
     * Returns true if the given object is an instance of ResourcePPPSecret.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is ResourcePPPSecret {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === ResourcePPPSecret.__pulumiType;
    }
     ...
     */
    constructor(name: string, args?: ResourcePPPSecretArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: ResourcePPPSecretArgs | ResourcePPPSecretState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as ResourcePPPSecretState | undefined;
            ...
            const args = argsOrState as ResourcePPPSecretArgs | undefined;
        ...
        super(ResourcePPPSecret.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface ResourcePPPSecretState {
    /**
     * <em>Resource ID type (.id / name). This is an internal service field, setting a value is not required.</em>
     */
 ...
 */
export interface ResourcePPPSecretArgs {
    /**
     * <em>Resource ID type (.id / name). This is an internal service field, setting a value is not required.</em>
     */
    ___id_?: pulumi.Input<number>;
