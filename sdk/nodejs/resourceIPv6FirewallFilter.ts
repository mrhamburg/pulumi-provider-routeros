 ...
 *
 * const rule = new routeros.ResourceIPv6FirewallFilter("rule", {
 *     action: "accept",
 *     chain: "forward",
 ...
 * ```
 */
export class ResourceIPv6FirewallFilter extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ResourceIPv6FirewallFilterState, opts?: pulumi.CustomResourceOptions): ResourceIPv6FirewallFilter {
        return new ResourceIPv6FirewallFilter(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'routeros:index/resourceIPv6FirewallFilter:ResourceIPv6FirewallFilter';

    /**
     * Returns true if the given object is an instance of ResourceIPv6FirewallFilter.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is ResourceIPv6FirewallFilter {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === ResourceIPv6FirewallFilter.__pulumiType;
    }
     ...
     */
    public readonly addressListTimeout!: pulumi.Output<string>;
    /**
     ...
     */
    public readonly hopLimit!: pulumi.Output<string | undefined>;
    /**
     ...
     */
    constructor(name: string, args: ResourceIPv6FirewallFilterArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: ResourceIPv6FirewallFilterArgs | ResourceIPv6FirewallFilterState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as ResourceIPv6FirewallFilterState | undefined;
            ...
            const args = argsOrState as ResourceIPv6FirewallFilterArgs | undefined;
        ...
        super(ResourceIPv6FirewallFilter.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface ResourceIPv6FirewallFilterState {
    /**
     * <em>Resource ID type (.id / name). This is an internal service field, setting a value is not required.</em>
     */
 ...
 */
export interface ResourceIPv6FirewallFilterArgs {
    /**
     * <em>Resource ID type (.id / name). This is an internal service field, setting a value is not required.</em>
     */
    ___id_?: pulumi.Input<number>;
