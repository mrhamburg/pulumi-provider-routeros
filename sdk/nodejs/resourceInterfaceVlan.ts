 ...
 *
 * const interfaceVlan = new routeros.ResourceInterfaceVlan("interfaceVlan", {
 *     "interface": "bridge",
 *     vlanId: 50,
 * });
 * ```
 ...
 * ```
 */
export class ResourceInterfaceVlan extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ResourceInterfaceVlanState, opts?: pulumi.CustomResourceOptions): ResourceInterfaceVlan {
        return new ResourceInterfaceVlan(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'routeros:index/resourceInterfaceVlan:ResourceInterfaceVlan';

    /**
     * Returns true if the given object is an instance of ResourceInterfaceVlan.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is ResourceInterfaceVlan {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === ResourceInterfaceVlan.__pulumiType;
    }
     ...
     */
    constructor(name: string, args: ResourceInterfaceVlanArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: ResourceInterfaceVlanArgs | ResourceInterfaceVlanState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as ResourceInterfaceVlanState | undefined;
            ...
            const args = argsOrState as ResourceInterfaceVlanArgs | undefined;
        ...
        super(ResourceInterfaceVlan.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface ResourceInterfaceVlanState {
    /**
     * <em>Resource ID type (.id / name). This is an internal service field, setting a value is not required.</em>
     */
 ...
 */
export interface ResourceInterfaceVlanArgs {
    /**
     * <em>Resource ID type (.id / name). This is an internal service field, setting a value is not required.</em>
     */
    ___id_?: pulumi.Input<number>;
