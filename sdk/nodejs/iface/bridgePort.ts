 ...
 */
export class BridgePort extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: BridgePortState, opts?: pulumi.CustomResourceOptions): BridgePort {
        return new BridgePort(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'routeros:Iface/bridgePort:BridgePort';

    /**
     * Returns true if the given object is an instance of BridgePort.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is BridgePort {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === BridgePort.__pulumiType;
    }
    ...
    constructor(name: string, argsOrState?: BridgePortArgs | BridgePortState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as BridgePortState | undefined;
            ...
            const args = argsOrState as BridgePortArgs | undefined;
        ...
        super(BridgePort.__pulumiType, name, resourceInputs, opts);
    }
}
