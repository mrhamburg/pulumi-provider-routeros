 ...
 */
export class Vrrp extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: VrrpState, opts?: pulumi.CustomResourceOptions): Vrrp {
        return new Vrrp(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'routeros:Iface/vrrp:Vrrp';

    /**
     * Returns true if the given object is an instance of Vrrp.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is Vrrp {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === Vrrp.__pulumiType;
    }
     ...
     */
    constructor(name: string, args: VrrpArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: VrrpArgs | VrrpState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as VrrpState | undefined;
            ...
            const args = argsOrState as VrrpArgs | undefined;
        ...
        super(Vrrp.__pulumiType, name, resourceInputs, opts);
    }
}
