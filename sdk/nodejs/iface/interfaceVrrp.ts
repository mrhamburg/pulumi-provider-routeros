 ...
 * ```
 */
export class InterfaceVrrp extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: InterfaceVrrpState, opts?: pulumi.CustomResourceOptions): InterfaceVrrp {
        return new InterfaceVrrp(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'routeros:Iface/interfaceVrrp:InterfaceVrrp';

    /**
     * Returns true if the given object is an instance of InterfaceVrrp.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is InterfaceVrrp {
    ...
    constructor(name: string, argsOrState?: InterfaceVrrpArgs | InterfaceVrrpState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as InterfaceVrrpState | undefined;
            ...
            const args = argsOrState as InterfaceVrrpArgs | undefined;
        ...
        super(InterfaceVrrp.__pulumiType, name, resourceInputs, opts);
    }
}
