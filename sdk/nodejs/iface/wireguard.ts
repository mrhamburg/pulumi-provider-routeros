 ...
 */
export class Wireguard extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: WireguardState, opts?: pulumi.CustomResourceOptions): Wireguard {
        return new Wireguard(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'routeros:Iface/wireguard:Wireguard';

    /**
     * Returns true if the given object is an instance of Wireguard.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is Wireguard {
    ...
    constructor(name: string, argsOrState?: WireguardArgs | WireguardState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as WireguardState | undefined;
            ...
            const args = argsOrState as WireguardArgs | undefined;
        ...
        super(Wireguard.__pulumiType, name, resourceInputs, opts);
    }
}
