 ...
 * ```
 */
export class InterfaceGre extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: InterfaceGreState, opts?: pulumi.CustomResourceOptions): InterfaceGre {
        return new InterfaceGre(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'routeros:Iface/interfaceGre:InterfaceGre';

    /**
     * Returns true if the given object is an instance of InterfaceGre.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is InterfaceGre {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === InterfaceGre.__pulumiType;
    }
    ...
    constructor(name: string, argsOrState?: InterfaceGreArgs | InterfaceGreState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as InterfaceGreState | undefined;
            ...
            const args = argsOrState as InterfaceGreArgs | undefined;
        ...
        super(InterfaceGre.__pulumiType, name, resourceInputs, opts);
    }
}
