 ...
 * ```
 */
export class InterfaceBridge extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: InterfaceBridgeState, opts?: pulumi.CustomResourceOptions): InterfaceBridge {
        return new InterfaceBridge(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'routeros:Iface/interfaceBridge:InterfaceBridge';

    /**
     * Returns true if the given object is an instance of InterfaceBridge.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is InterfaceBridge {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === InterfaceBridge.__pulumiType;
    }
     ...
     */
    constructor(name: string, args?: InterfaceBridgeArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: InterfaceBridgeArgs | InterfaceBridgeState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as InterfaceBridgeState | undefined;
            ...
            const args = argsOrState as InterfaceBridgeArgs | undefined;
        ...
        super(InterfaceBridge.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface InterfaceBridgeState {
    /**
     * <em>Resource ID type (.id / name). This is an internal service field, setting a value is not required.</em>
     */
 ...
 */
export interface InterfaceBridgeArgs {
    /**
     * <em>Resource ID type (.id / name). This is an internal service field, setting a value is not required.</em>
     */
    ___id_?: pulumi.Input<number>;
