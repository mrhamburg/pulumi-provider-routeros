 ...
 *     winbox: 8291,
 * };
 * const tlsCert = new routeros.ResourceSystemCertificate("tlsCert", {
 ...
 * const tls: routeros.ResourceIpService[] = [];
 * for (const range of Object.entries(tlsService).map(([k, v]) => ({key: k, value: v}))) {
 *     tls.push(new routeros.ResourceIpService(`tls-${range.key}`, {
 *         numbers: range.key,
 *         port: range.value,
 ...
 *     }));
 * }
 * const disabled: routeros.ResourceIpService[] = [];
 * for (const range of Object.entries(disableService).map(([k, v]) => ({key: k, value: v}))) {
 *     disabled.push(new routeros.ResourceIpService(`disabled-${range.key}`, {
 *         numbers: range.key,
 *         port: range.value,
 *         disabled: true,
 *     }));
 * }
 * const enabled: routeros.ResourceIpService[] = [];
 * for (const range of Object.entries(enableService).map(([k, v]) => ({key: k, value: v}))) {
 *     enabled.push(new routeros.ResourceIpService(`enabled-${range.key}`, {
 *         numbers: range.key,
 *         port: range.value,
 *         disabled: false,
 *     }));
 ...
 * ```
 */
export class ResourceIpService extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ResourceIpServiceState, opts?: pulumi.CustomResourceOptions): ResourceIpService {
        return new ResourceIpService(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'routeros:index/resourceIpService:ResourceIpService';

    /**
     * Returns true if the given object is an instance of ResourceIpService.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is ResourceIpService {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === ResourceIpService.__pulumiType;
    }
     ...
     */
    constructor(name: string, args: ResourceIpServiceArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: ResourceIpServiceArgs | ResourceIpServiceState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as ResourceIpServiceState | undefined;
            ...
            const args = argsOrState as ResourceIpServiceArgs | undefined;
        ...
        super(ResourceIpService.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface ResourceIpServiceState {
    /**
     * <em>Resource ID type (.id / name). This is an internal service field, setting a value is not required.</em>
     */
 ...
 */
export interface ResourceIpServiceArgs {
    /**
     * <em>Resource ID type (.id / name). This is an internal service field, setting a value is not required.</em>
     */
    ___id_?: pulumi.Input<number>;
