 ...
 *
 * const bridgeVlan = new routeros.ResourceInterfaceBridgeVlan("bridgeVlan", {
 *     bridge: "bridge",
 *     taggeds: [
 *         "bridge",
 *         "ether1",
 ...
 * ```
 */
export class ResourceInterfaceBridgeVlan extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ResourceInterfaceBridgeVlanState, opts?: pulumi.CustomResourceOptions): ResourceInterfaceBridgeVlan {
        return new ResourceInterfaceBridgeVlan(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'routeros:index/resourceInterfaceBridgeVlan:ResourceInterfaceBridgeVlan';

    /**
     * Returns true if the given object is an instance of ResourceInterfaceBridgeVlan.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is ResourceInterfaceBridgeVlan {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === ResourceInterfaceBridgeVlan.__pulumiType;
    }
     ...
     */
    constructor(name: string, args: ResourceInterfaceBridgeVlanArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: ResourceInterfaceBridgeVlanArgs | ResourceInterfaceBridgeVlanState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as ResourceInterfaceBridgeVlanState | undefined;
            ...
            const args = argsOrState as ResourceInterfaceBridgeVlanArgs | undefined;
        ...
        super(ResourceInterfaceBridgeVlan.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface ResourceInterfaceBridgeVlanState {
    /**
     * <em>Resource ID type (.id / name). This is an internal service field, setting a value is not required.</em>
     */
 ...
 */
export interface ResourceInterfaceBridgeVlanArgs {
    /**
     * <em>Resource ID type (.id / name). This is an internal service field, setting a value is not required.</em>
     */
    ___id_?: pulumi.Input<number>;
