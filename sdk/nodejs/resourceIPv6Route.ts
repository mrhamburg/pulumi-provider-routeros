 ...
 *
 * const aRoute = new routeros.ResourceIPv6Route("aRoute", {
 *     dstAddress: "::/0",
 ...
 * ```
 */
export class ResourceIPv6Route extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ResourceIPv6RouteState, opts?: pulumi.CustomResourceOptions): ResourceIPv6Route {
        return new ResourceIPv6Route(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'routeros:index/resourceIPv6Route:ResourceIPv6Route';

    /**
     * Returns true if the given object is an instance of ResourceIPv6Route.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is ResourceIPv6Route {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === ResourceIPv6Route.__pulumiType;
    }
     ...
     */
    constructor(name: string, args: ResourceIPv6RouteArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: ResourceIPv6RouteArgs | ResourceIPv6RouteState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as ResourceIPv6RouteState | undefined;
            ...
            const args = argsOrState as ResourceIPv6RouteArgs | undefined;
        ...
        super(ResourceIPv6Route.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface ResourceIPv6RouteState {
    /**
     * <em>Resource ID type (.id / name). This is an internal service field, setting a value is not required.</em>
     */
 ...
 */
export interface ResourceIPv6RouteArgs {
    /**
     * <em>Resource ID type (.id / name). This is an internal service field, setting a value is not required.</em>
     */
    ___id_?: pulumi.Input<number>;
