 ...
 *
 * const aRoute = new routeros.ResourceIPRoute("aRoute", {
 ...
 * ```
 */
export class ResourceIPRoute extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ResourceIPRouteState, opts?: pulumi.CustomResourceOptions): ResourceIPRoute {
        return new ResourceIPRoute(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'routeros:index/resourceIPRoute:ResourceIPRoute';

    /**
     * Returns true if the given object is an instance of ResourceIPRoute.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is ResourceIPRoute {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === ResourceIPRoute.__pulumiType;
    }
     ...
     */
    constructor(name: string, args: ResourceIPRouteArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: ResourceIPRouteArgs | ResourceIPRouteState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as ResourceIPRouteState | undefined;
            ...
            const args = argsOrState as ResourceIPRouteArgs | undefined;
        ...
        super(ResourceIPRoute.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface ResourceIPRouteState {
    /**
     * <em>Resource ID type (.id / name). This is an internal service field, setting a value is not required.</em>
     */
 ...
 */
export interface ResourceIPRouteArgs {
    /**
     * <em>Resource ID type (.id / name). This is an internal service field, setting a value is not required.</em>
     */
    ___id_?: pulumi.Input<number>;
