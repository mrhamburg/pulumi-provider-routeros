...
__all__ = ['ResourceIPFirewallNatArgs', 'ResourceIPFirewallNat']

@pulumi.input_type
class ResourceIPFirewallNatArgs:
    def __init__(__self__, *,
                 ...
                 same_not_by_dst: Optional[pulumi.Input[bool]] = None,
                 ...
                 to_addresses: Optional[pulumi.Input[str]] = None,
                 to_ports: Optional[pulumi.Input[str]] = None,
        ...
        :param pulumi.Input[bool] same_not_by_dst: Specifies whether to take into account or not destination IP address when selecting a new source IP address. Applicable
               if action=same
        ...
        :param pulumi.Input[str] time: Allows to create a filter based on the packets' arrival time and date or, for locally generated packets, departure time
               and date.
        :param pulumi.Input[str] to_addresses: Replace original address with specified one. Applicable if action is dst-nat, netmap, same, src-nat.
        :param pulumi.Input[str] to_ports: Replace the original port with the specified one. Applicable if action is dst-nat, redirect, masquerade, netmap, same,
               src-nat.
        ...
        if same_not_by_dst is not None:
    ...
    def same_not_by_dst(self) -> Optional[pulumi.Input[bool]]:
        """
    ...
    def same_not_by_dst(self, value: Optional[pulumi.Input[bool]]):
    ...
    def to_addresses(self) -> Optional[pulumi.Input[str]]:
        """
    ...
    @to_addresses.setter
    def to_addresses(self, value: Optional[pulumi.Input[str]]):
        pulumi.set(self, "to_addresses", value)

    @property
    @pulumi.getter(name="toPorts")
    def to_ports(self) -> Optional[pulumi.Input[str]]:
        """
    ...
    @to_ports.setter
    def to_ports(self, value: Optional[pulumi.Input[str]]):
...
@pulumi.input_type
class _ResourceIPFirewallNatState:
    def __init__(__self__, *,
                 ___id_: Optional[pulumi.Input[int]] = None,
                 ___path_: Optional[pulumi.Input[str]] = None,
...
class ResourceIPFirewallNat(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
        ...
        rule = routeros.ResourceIPFirewallNat("rule",
            action="masquerade",
            chain="srcnat",
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: ResourceIPFirewallNatArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        ## Example Usage
        ...
        :param str resource_name: The name of the resource.
        :param ResourceIPFirewallNatArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(ResourceIPFirewallNatArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = ResourceIPFirewallNatArgs.__new__(ResourceIPFirewallNatArgs)
            ...
            __props__.__dict__["same_not_by_dst"] = same_not_by_dst
            ...
            __props__.__dict__["to_addresses"] = to_addresses
            __props__.__dict__["to_ports"] = to_ports
        ...
        super(ResourceIPFirewallNat, __self__).__init__(
            'routeros:index/resourceIPFirewallNat:ResourceIPFirewallNat',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            to_addresses: Optional[pulumi.Input[str]] = None,
            to_ports: Optional[pulumi.Input[str]] = None,
            ttl: Optional[pulumi.Input[str]] = None) -> 'ResourceIPFirewallNat':
        """
        Get an existing ResourceIPFirewallNat resource's state with the given name, id, and optional extra
        ...
        __props__ = _ResourceIPFirewallNatState.__new__(_ResourceIPFirewallNatState)
        ...
        __props__.__dict__["to_ports"] = to_ports
        __props__.__dict__["ttl"] = ttl
        return ResourceIPFirewallNat(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter(name="sameNotByDst")
    def same_not_by_dst(self) -> pulumi.Output[Optional[bool]]:
        """
        Specifies whether to take into account or not destination IP address when selecting a new source IP address. Applicable
        if action=same
        """
    ...
    @property
    @pulumi.getter(name="toAddresses")
    def to_addresses(self) -> pulumi.Output[Optional[str]]:
        """
        Replace original address with specified one. Applicable if action is dst-nat, netmap, same, src-nat.
        """
        return pulumi.get(self, "to_addresses")
    ...
    @property
    @pulumi.getter(name="toPorts")
    def to_ports(self) -> pulumi.Output[Optional[str]]:
        """
        Replace the original port with the specified one. Applicable if action is dst-nat, redirect, masquerade, netmap, same,
        src-nat.
        """
