...
__all__ = [
    'DatasourceIPAddressesResult',
    'AwaitableDatasourceIPAddressesResult',
    'datasource_ip_addresses',
    'datasource_ip_addresses_output',
]

@pulumi.output_type
class DatasourceIPAddressesResult:
    """
    ...
    @property
    @pulumi.getter
    def addresses(self) -> Sequence['outputs.DatasourceIPAddressesAddressResult']:
...
class AwaitableDatasourceIPAddressesResult(DatasourceIPAddressesResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return DatasourceIPAddressesResult(
            ___id_=self.___id_,
...
def datasource_ip_addresses(___id_: Optional[int] = None,
                            ___path_: Optional[str] = None,
                            filter: Optional[Mapping[str, Any]] = None,
                            opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableDatasourceIPAddressesResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('routeros:index/datasourceIPAddresses:DatasourceIPAddresses', __args__, opts=opts, typ=DatasourceIPAddressesResult).value

    return AwaitableDatasourceIPAddressesResult(
...
@_utilities.lift_output_func(datasource_ip_addresses)
def datasource_ip_addresses_output(___id_: Optional[pulumi.Input[Optional[int]]] = None,
                                   ___path_: Optional[pulumi.Input[Optional[str]]] = None,
                                   filter: Optional[pulumi.Input[Optional[Mapping[str, Any]]]] = None,
                                   opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[DatasourceIPAddressesResult]:
    """
    Use this data source to access information about an existing resource.
