...
__all__ = ['ResourceDnsArgs', 'ResourceDns']

@pulumi.input_type
class ResourceDnsArgs:
...
class ResourceDns(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[ResourceDnsArgs] = None,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        ## # ResourceDns (Resource)
        ...
        :param str resource_name: The name of the resource.
        :param ResourceDnsArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(ResourceDnsArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = ResourceDnsArgs.__new__(ResourceDnsArgs)
        ...
        super(ResourceDns, __self__).__init__(
            'routeros:index/resourceDns:ResourceDns',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            servers: Optional[pulumi.Input[str]] = None,
            use_doh_server: Optional[pulumi.Input[str]] = None,
            verify_doh_cert: Optional[pulumi.Input[bool]] = None) -> 'ResourceDns':
        """
        ...
        __props__ = _ResourceDnsState.__new__(_ResourceDnsState)
        ...
        __props__.__dict__["use_doh_server"] = use_doh_server
        __props__.__dict__["verify_doh_cert"] = verify_doh_cert
        return ResourceDns(resource_name, opts=opts, __props__=__props__)
