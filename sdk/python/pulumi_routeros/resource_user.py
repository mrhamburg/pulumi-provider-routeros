...
__all__ = ['ResourceUserArgs', 'ResourceUser']

@pulumi.input_type
class ResourceUserArgs:
...
class ResourceUser(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
        ...
        test = routeros.ResourceUser("test",
            address="0.0.0.0/0",
            comment="Test User",
            group="read",
            password="secret")
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param ResourceUserArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(ResourceUserArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = ResourceUserArgs.__new__(ResourceUserArgs)
        ...
        super(ResourceUser, __self__).__init__(
            'routeros:index/resourceUser:ResourceUser',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            last_logged_in: Optional[pulumi.Input[str]] = None,
            name: Optional[pulumi.Input[str]] = None,
            password: Optional[pulumi.Input[str]] = None) -> 'ResourceUser':
        """
        ...
        __props__ = _ResourceUserState.__new__(_ResourceUserState)
        ...
        return ResourceUser(resource_name, opts=opts, __props__=__props__)
