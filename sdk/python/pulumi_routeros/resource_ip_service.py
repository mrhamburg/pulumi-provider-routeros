...
__all__ = ['ResourceIpServiceArgs', 'ResourceIpService']

@pulumi.input_type
class ResourceIpServiceArgs:
...
class ResourceIpService(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
        ...
        tls_cert = routeros.ResourceSystemCertificate("tlsCert",
        ...
        for range in [{"key": k, "value": v} for [k, v] in enumerate(tls_service)]:
            tls.append(routeros.ResourceIpService(f"tls-{range['key']}",
                numbers=range["key"],
                port=range["value"],
        ...
        for range in [{"key": k, "value": v} for [k, v] in enumerate(disable_service)]:
            disabled.append(routeros.ResourceIpService(f"disabled-{range['key']}",
                numbers=range["key"],
                port=range["value"],
                disabled=True))
        enabled = []
        for range in [{"key": k, "value": v} for [k, v] in enumerate(enable_service)]:
            enabled.append(routeros.ResourceIpService(f"enabled-{range['key']}",
                numbers=range["key"],
                port=range["value"],
                disabled=False))
        ```
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param ResourceIpServiceArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(ResourceIpServiceArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = ResourceIpServiceArgs.__new__(ResourceIpServiceArgs)
        ...
        super(ResourceIpService, __self__).__init__(
            'routeros:index/resourceIpService:ResourceIpService',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            port: Optional[pulumi.Input[int]] = None,
            tls_version: Optional[pulumi.Input[str]] = None,
            vrf: Optional[pulumi.Input[str]] = None) -> 'ResourceIpService':
        """
        ...
        __props__ = _ResourceIpServiceState.__new__(_ResourceIpServiceState)
        ...
        __props__.__dict__["tls_version"] = tls_version
        __props__.__dict__["vrf"] = vrf
        return ResourceIpService(resource_name, opts=opts, __props__=__props__)
