...
__all__ = ['ResourcePPPSecretArgs', 'ResourcePPPSecret']

@pulumi.input_type
class ResourcePPPSecretArgs:
...
class ResourcePPPSecret(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
        ...
        test = routeros.ResourcePPPSecret("test",
            password="123",
            profile="default")
        ```
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[ResourcePPPSecretArgs] = None,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        ## Example Usage
        ...
        :param str resource_name: The name of the resource.
        :param ResourcePPPSecretArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(ResourcePPPSecretArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = ResourcePPPSecretArgs.__new__(ResourcePPPSecretArgs)
        ...
        super(ResourcePPPSecret, __self__).__init__(
            'routeros:index/resourcePPPSecret:ResourcePPPSecret',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            remote_ipv6_prefix: Optional[pulumi.Input[str]] = None,
            routes: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
            service: Optional[pulumi.Input[str]] = None) -> 'ResourcePPPSecret':
        """
        ...
        __props__ = _ResourcePPPSecretState.__new__(_ResourcePPPSecretState)
        ...
        __props__.__dict__["routes"] = routes
        __props__.__dict__["service"] = service
        return ResourcePPPSecret(resource_name, opts=opts, __props__=__props__)
