...
__all__ = ['ResourceInterfaceBridgeArgs', 'ResourceInterfaceBridge']

@pulumi.input_type
class ResourceInterfaceBridgeArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[bool] add_dhcp_option82: Whether to add DHCP Option-82 information (Agent Remote ID and Agent Circuit ID) to DHCP packets. Can be used together with Option-82 capable DHCP server to assign IP addresses and implement policies. This property only has effect when dhcp-snooping is set to yes.
        ...
        :param pulumi.Input[bool] auto_mac: Automatically select one MAC address of bridge ports as a bridge MAC address, bridge MAC will be chosen from the first added bridge port. After a device reboot, the bridge MAC can change depending on the port-number.
        :param pulumi.Input[str] ether_type: This property only has effect when vlan-filtering is set to yes.
        :param pulumi.Input[str] forward_delay: Time which is spent during the initialization phase of the bridge interface (i.e., after router startup or enabling the interface) in listening/learning state before the bridge will start functioning normally.
        ...
        :param pulumi.Input[int] igmp_version: Selects the IGMP version in which IGMP general membership queries will be generated. This property only has effect when igmp-snooping is set to yes.
        ...
        :param pulumi.Input[str] last_member_interval: If a port has fast-leave set to no and a bridge port receives a IGMP Leave message, then a IGMP Snooping enabled bridge will send a IGMP query to make sure that no devices has subscribed to a certain multicast stream on a bridge port.
        :param pulumi.Input[int] last_member_query_count: How many times should last-member-interval pass until a IGMP Snooping bridge will stop forwarding a certain multicast stream. This property only has effect when igmp-snooping is set to yes.
        :param pulumi.Input[int] max_hops: Bridge count which BPDU can pass in a MSTP enabled network in the same region before BPDU is being ignored. This property only has effect when protocol-mode is set to mstp.
        :param pulumi.Input[str] max_message_age: Changes the Max Age value in BPDU packets, which is transmitted by the root bridge. This property only has effect when protocol-mode is set to stp or rstp. Value: 6s..40s
        :param pulumi.Input[str] membership_interval: Amount of time after an entry in the Multicast Database (MDB) is removed if a IGMP membership report is not received on a certain port. This property only has effect when igmp-snooping is set to yes.
        :param pulumi.Input[int] mld_version: Selects the MLD version. Version 2 adds support for source-specific multicast. This property only has effect when RouterOS IPv6 package is enabled and igmp-snooping is set to yes.
        :param pulumi.Input[str] mtu: The default bridge MTU value without any bridge ports added is 1500. The MTU value can be set manually, but it cannot exceed the bridge L2MTU or the lowest bridge port L2MTU. If a new bridge port is added with L2MTU which is smaller than the actual-mtu of the bridge (set by the mtu property), then manually set value will be ignored and the bridge will act as if mtu=auto is set.
        :param pulumi.Input[bool] multicast_querier: Multicast querier generates IGMP general membership queries to which all IGMP capable devices respond with an IGMP membership report, usually a PIM (multicast) router or IGMP proxy generates these queries. This property only has an effect when igmp-snooping is set to yes. Additionally, the igmp-snooping should be disabled/enabled after changing multicast-querier property.
        :param pulumi.Input[str] multicast_router: A multicast router port is a port where a multicast router or querier is connected. On this port, unregistered multicast streams and IGMP/MLD membership reports will be sent. This setting changes the state of the multicast router for a bridge interface itself. This property can be used to send IGMP/MLD membership reports and multicast traffic to the bridge interface for further multicast routing or proxying. This property only has an effect when igmp-snooping is set to yes.
        ...
        :param pulumi.Input[str] priority: Bridge priority, used by STP to determine root bridge, used by MSTP to determine CIST and IST regional root bridge. This property has no effect when protocol-mode is set to none.
        :param pulumi.Input[str] protocol_mode: Select Spanning tree protocol (STP) or Rapid spanning tree protocol (RSTP) to ensure a loop-free topology for any bridged LAN.
        :param pulumi.Input[int] pvid: Port VLAN ID (pvid) specifies which VLAN the untagged ingress traffic is assigned to. It applies e.g. to frames sent from bridge IP and destined to a bridge port. This property only has effect when vlan-filtering is set to yes.
        :param pulumi.Input[str] querier_interval: Used to change the interval how often a bridge checks if it is the active multicast querier. This property only has effect when igmp-snooping and multicast-querier is set to yes.
        :param pulumi.Input[str] query_interval: Used to change the interval how often IGMP general membership queries are sent out. This property only has effect when igmp-snooping and multicast-querier is set to yes.
        :param pulumi.Input[str] query_response_interval: Interval in which a IGMP capable device must reply to a IGMP query with a IGMP membership report. This property only has effect when igmp-snooping and multicast-querier is set to yes.
        ...
        :param pulumi.Input[int] startup_query_count: Specifies how many times must startup-query-interval pass until the bridge starts sending out IGMP general membership queries periodically. This property only has effect when igmp-snooping and multicast-querier is set to yes.
        :param pulumi.Input[str] startup_query_interval: Used to change the amount of time after a bridge starts sending out IGMP general membership queries after the bridge is enabled. This property only has effect when igmp-snooping and multicast-querier is set to yes.
...
@pulumi.input_type
class _ResourceInterfaceBridgeState:
    def __init__(__self__, *,
                 ___id_: Optional[pulumi.Input[int]] = None,
                 ___path_: Optional[pulumi.Input[str]] = None,
...
class ResourceInterfaceBridge(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
        ...
        bridge = routeros.ResourceInterfaceBridge("bridge", vlan_filtering=True)
        ```
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[ResourceInterfaceBridgeArgs] = None,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        ## Example Usage
        ...
        :param str resource_name: The name of the resource.
        :param ResourceInterfaceBridgeArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(ResourceInterfaceBridgeArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = ResourceInterfaceBridgeArgs.__new__(ResourceInterfaceBridgeArgs)
        ...
        super(ResourceInterfaceBridge, __self__).__init__(
            'routeros:index/resourceInterfaceBridge:ResourceInterfaceBridge',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            startup_query_interval: Optional[pulumi.Input[str]] = None,
            transmit_hold_count: Optional[pulumi.Input[int]] = None,
            vlan_filtering: Optional[pulumi.Input[bool]] = None) -> 'ResourceInterfaceBridge':
        """
        ...
        __props__ = _ResourceInterfaceBridgeState.__new__(_ResourceInterfaceBridgeState)
        ...
        __props__.__dict__["transmit_hold_count"] = transmit_hold_count
        __props__.__dict__["vlan_filtering"] = vlan_filtering
        return ResourceInterfaceBridge(resource_name, opts=opts, __props__=__props__)
