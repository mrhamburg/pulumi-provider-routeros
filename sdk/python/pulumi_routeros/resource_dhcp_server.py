...
__all__ = ['ResourceDhcpServerArgs', 'ResourceDhcpServer']

@pulumi.input_type
class ResourceDhcpServerArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] address_pool: IP pool, from which to take IP addresses for the clients. If set to static-only, then only the clients that have a static lease (added in lease submenu) will be allowed.
        :param pulumi.Input[bool] allow_dual_stack_queue: Creates a single simple queue entry for both IPv4 and IPv6 addresses, uses the MAC address and DUID for identification. Requires IPv6 DHCP Server to have this option enabled as well to work properly.
        ...
        :param pulumi.Input[str] bootp_lease_time: Accepts two predefined options or time value: * forever - lease never expires * lease-time - use time from lease-time parameter
        ...
        :param pulumi.Input[bool] conflict_detection: Allows to disable/enable conflict detection. If option is enabled, then whenever server tries to assign a lease it will send ICMP and ARP messages to detect whether such address in the network already exist. If any of above get reply address is considered already used. Conflict detection must be disabled when any kind of DHCP client limitation per port or per mac is used.
        :param pulumi.Input[str] delay_threshold: If secs field in DHCP packet is smaller than delay-threshold, then this packet is ignored. If set to none - there is no threshold (all DHCP packets are processed).
        ...
        :param pulumi.Input[str] lease_time: The time that a client may use the assigned address. The client will try to renew this address after half of this time and will request a new address after the time limit expires.
...
@pulumi.input_type
class _ResourceDhcpServerState:
    def __init__(__self__, *,
                 ___id_: Optional[pulumi.Input[int]] = None,
                 ___path_: Optional[pulumi.Input[str]] = None,
                 add_arp: Optional[pulumi.Input[bool]] = None,
...
class ResourceDhcpServer(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
        ...
        server = routeros.ResourceDhcpServer("server",
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param ResourceDhcpServerArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(ResourceDhcpServerArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = ResourceDhcpServerArgs.__new__(ResourceDhcpServerArgs)
        ...
        super(ResourceDhcpServer, __self__).__init__(
            'routeros:index/resourceDhcpServer:ResourceDhcpServer',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            src_address: Optional[pulumi.Input[str]] = None,
            use_framed_as_classless: Optional[pulumi.Input[bool]] = None,
            use_radius: Optional[pulumi.Input[str]] = None) -> 'ResourceDhcpServer':
        """
        ...
        __props__ = _ResourceDhcpServerState.__new__(_ResourceDhcpServerState)
        ...
        __props__.__dict__["use_framed_as_classless"] = use_framed_as_classless
        __props__.__dict__["use_radius"] = use_radius
        return ResourceDhcpServer(resource_name, opts=opts, __props__=__props__)
