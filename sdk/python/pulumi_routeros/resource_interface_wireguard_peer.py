...
__all__ = ['ResourceInterfaceWireguardPeerArgs', 'ResourceInterfaceWireguardPeer']

@pulumi.input_type
class ResourceInterfaceWireguardPeerArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] persistent_keepalive: A seconds interval, between 1 and 65535 inclusive, of how often to send an authenticated empty packet to the peer for the purpose of keeping a stateful firewall or NAT mapping valid persistently. For example, if the interface very rarely sends traffic, but it might at anytime receive traffic from a peer, and it is behind NAT, the interface might benefit from having a persistent keepalive interval of 25 seconds.
        :param pulumi.Input[str] preshared_key: A **base64** preshared key. Optional, and may be omitted. This option adds an additional layer of symmetric-key cryptography to be mixed into the already existing public-key cryptography, for post-quantum resistance.
        """
...
@pulumi.input_type
class _ResourceInterfaceWireguardPeerState:
    def __init__(__self__, *,
                 ___id_: Optional[pulumi.Input[int]] = None,
                 ___path_: Optional[pulumi.Input[str]] = None,
                 allowed_addresses: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
...
class ResourceInterfaceWireguardPeer(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
        ...
        wg_peer = routeros.ResourceInterfaceWireguardPeer("wgPeer",
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: ResourceInterfaceWireguardPeerArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        ## Example Usage
        ...
        :param str resource_name: The name of the resource.
        :param ResourceInterfaceWireguardPeerArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(ResourceInterfaceWireguardPeerArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = ResourceInterfaceWireguardPeerArgs.__new__(ResourceInterfaceWireguardPeerArgs)
        ...
        super(ResourceInterfaceWireguardPeer, __self__).__init__(
            'routeros:index/resourceInterfaceWireguardPeer:ResourceInterfaceWireguardPeer',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            public_key: Optional[pulumi.Input[str]] = None,
            rx: Optional[pulumi.Input[str]] = None,
            tx: Optional[pulumi.Input[str]] = None) -> 'ResourceInterfaceWireguardPeer':
        """
        ...
        __props__ = _ResourceInterfaceWireguardPeerState.__new__(_ResourceInterfaceWireguardPeerState)
        ...
        return ResourceInterfaceWireguardPeer(resource_name, opts=opts, __props__=__props__)
