...
__all__ = ['ResourceDhcpServerLeaseArgs', 'ResourceDhcpServerLease']

@pulumi.input_type
class ResourceDhcpServerLeaseArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[bool] dynamic: Whether the dhcp lease is static or dynamic. Dynamic leases are not guaranteed to continue to be assigned to that specific device. Defaults to false.
...
@pulumi.input_type
class _ResourceDhcpServerLeaseState:
    def __init__(__self__, *,
                 ___id_: Optional[pulumi.Input[int]] = None,
                 ___path_: Optional[pulumi.Input[str]] = None,
        ...
        :param pulumi.Input[str] address: The IP address of the DHCP lease to be created.
        :param pulumi.Input[str] address_lists: Address list to which address will be added if lease is bound.
        :param pulumi.Input[str] agent_circuit_id: Circuit ID of DHCP relay agent. If each character should be valid ASCII text symbol or else this value is displayed as hex dump.
...
class ResourceDhcpServerLease(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
        ...
        dhcp_lease = routeros.ResourceDhcpServerLease("dhcpLease",
            address="10.0.0.2",
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: ResourceDhcpServerLeaseArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        ## # ResourceDhcpServerLease (Resource)
        ...
        :param str resource_name: The name of the resource.
        :param ResourceDhcpServerLeaseArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(ResourceDhcpServerLeaseArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = ResourceDhcpServerLeaseArgs.__new__(ResourceDhcpServerLeaseArgs)
        ...
        super(ResourceDhcpServerLease, __self__).__init__(
            'routeros:index/resourceDhcpServerLease:ResourceDhcpServerLease',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            src_mac_address: Optional[pulumi.Input[str]] = None,
            status: Optional[pulumi.Input[str]] = None,
            use_src_mac: Optional[pulumi.Input[bool]] = None) -> 'ResourceDhcpServerLease':
        """
        ...
        __props__ = _ResourceDhcpServerLeaseState.__new__(_ResourceDhcpServerLeaseState)
        ...
        __props__.__dict__["use_src_mac"] = use_src_mac
        return ResourceDhcpServerLease(resource_name, opts=opts, __props__=__props__)
