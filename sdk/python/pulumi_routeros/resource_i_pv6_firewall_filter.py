...
__all__ = ['ResourceIPv6FirewallFilterArgs', 'ResourceIPv6FirewallFilter']

@pulumi.input_type
class ResourceIPv6FirewallFilterArgs:
    def __init__(__self__, *,
                 ...
                 hop_limit: Optional[pulumi.Input[str]] = None,
        ...
        :param pulumi.Input[str] headers: Extension headers. Look at the Extras tab in the v6 filter rules.
        :param pulumi.Input[str] hop_limit: IPv6 TTL. Look at the Extras tab in the v6 filter rules.
        ...
        if hop_limit is not None:
            pulumi.set(__self__, "hop_limit", hop_limit)
    ...
    @property
    @pulumi.getter(name="hopLimit")
    def hop_limit(self) -> Optional[pulumi.Input[str]]:
        """
        IPv6 TTL. Look at the Extras tab in the v6 filter rules.
        """
        return pulumi.get(self, "hop_limit")

    @hop_limit.setter
    def hop_limit(self, value: Optional[pulumi.Input[str]]):
        pulumi.set(self, "hop_limit", value)
...
@pulumi.input_type
class _ResourceIPv6FirewallFilterState:
    def __init__(__self__, *,
                 ___id_: Optional[pulumi.Input[int]] = None,
                 ___path_: Optional[pulumi.Input[str]] = None,
...
class ResourceIPv6FirewallFilter(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
        ...
        rule = routeros.ResourceIPv6FirewallFilter("rule",
            action="accept",
            chain="forward",
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: ResourceIPv6FirewallFilterArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        ## Example Usage
        ...
        :param str resource_name: The name of the resource.
        :param ResourceIPv6FirewallFilterArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(ResourceIPv6FirewallFilterArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = ResourceIPv6FirewallFilterArgs.__new__(ResourceIPv6FirewallFilterArgs)
            ...
            __props__.__dict__["hop_limit"] = hop_limit
        ...
        super(ResourceIPv6FirewallFilter, __self__).__init__(
            'routeros:index/resourceIPv6FirewallFilter:ResourceIPv6FirewallFilter',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            tcp_mss: Optional[pulumi.Input[str]] = None,
            time: Optional[pulumi.Input[str]] = None,
            tls_host: Optional[pulumi.Input[str]] = None) -> 'ResourceIPv6FirewallFilter':
        """
        ...
        __props__ = _ResourceIPv6FirewallFilterState.__new__(_ResourceIPv6FirewallFilterState)
        ...
        __props__.__dict__["time"] = time
        __props__.__dict__["tls_host"] = tls_host
        return ResourceIPv6FirewallFilter(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter(name="addressListTimeout")
    def address_list_timeout(self) -> pulumi.Output[str]:
        """
        Time interval after which the address will be removed from the address list specified by address-list parameter. Used in
        conjunction with add-dst-to-address-list or add-src-to-address-list actions.
        """
    ...
    @property
    @pulumi.getter(name="hopLimit")
    def hop_limit(self) -> pulumi.Output[Optional[str]]:
        """
        IPv6 TTL. Look at the Extras tab in the v6 filter rules.
        """
        return pulumi.get(self, "hop_limit")
