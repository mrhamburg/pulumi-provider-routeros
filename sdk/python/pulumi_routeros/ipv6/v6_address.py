...
__all__ = ['V6AddressArgs', 'V6Address']
...
class V6Address(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param V6AddressArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(V6AddressArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = V6AddressArgs.__new__(V6AddressArgs)
        ...
        super(V6Address, __self__).__init__(
    ...
    def get(resource_name: str,
            ...
            invalid: Optional[pulumi.Input[bool]] = None,
            link_local: Optional[pulumi.Input[bool]] = None,
            no_dad: Optional[pulumi.Input[bool]] = None) -> 'V6Address':
        """
        ...
        __props__ = _V6AddressState.__new__(_V6AddressState)
        ...
        __props__.__dict__["no_dad"] = no_dad
        return V6Address(resource_name, opts=opts, __props__=__props__)
