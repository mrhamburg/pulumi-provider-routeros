...
__all__ = ['ProvisioningArgs', 'Provisioning']
...
class Provisioning(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param ProvisioningArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(ProvisioningArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = ProvisioningArgs.__new__(ProvisioningArgs)
        ...
        super(Provisioning, __self__).__init__(
    ...
    def get(resource_name: str,
            ...
            name_prefix: Optional[pulumi.Input[str]] = None,
            radio_mac: Optional[pulumi.Input[str]] = None,
            slave_configurations: Optional[pulumi.Input[str]] = None) -> 'Provisioning':
        """
        ...
        __props__ = _ProvisioningState.__new__(_ProvisioningState)
        ...
        __props__.__dict__["radio_mac"] = radio_mac
        __props__.__dict__["slave_configurations"] = slave_configurations
        return Provisioning(resource_name, opts=opts, __props__=__props__)
