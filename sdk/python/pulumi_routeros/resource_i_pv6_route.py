...
__all__ = ['ResourceIPv6RouteArgs', 'ResourceIPv6Route']

@pulumi.input_type
class ResourceIPv6RouteArgs:
    def __init__(__self__, *,
                 dst_address: pulumi.Input[str],
    ...
    def dst_address(self) -> pulumi.Input[str]:
        """
    ...
    @dst_address.setter
    def dst_address(self, value: pulumi.Input[str]):
...
class ResourceIPv6Route(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
        ...
        a_route = routeros.ResourceIPv6Route("aRoute",
            dst_address="::/0",
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param ResourceIPv6RouteArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(ResourceIPv6RouteArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = ResourceIPv6RouteArgs.__new__(ResourceIPv6RouteArgs)
            ...
            if dst_address is None and not opts.urn:
                raise TypeError("Missing required property 'dst_address'")
        ...
        super(ResourceIPv6Route, __self__).__init__(
            'routeros:index/resourceIPv6Route:ResourceIPv6Route',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            suppress_hw_offload: Optional[pulumi.Input[bool]] = None,
            target_scope: Optional[pulumi.Input[int]] = None,
            vrf_interface: Optional[pulumi.Input[str]] = None) -> 'ResourceIPv6Route':
        """
        ...
        __props__ = _ResourceIPv6RouteState.__new__(_ResourceIPv6RouteState)
        ...
        __props__.__dict__["target_scope"] = target_scope
        __props__.__dict__["vrf_interface"] = vrf_interface
        return ResourceIPv6Route(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter(name="dstAddress")
    def dst_address(self) -> pulumi.Output[str]:
        """
        IP prefix of route, specifies destination addresses that this route can be used for.
        """
        return pulumi.get(self, "dst_address")
