...
__all__ = ['BridgePortArgs', 'BridgePort']

@pulumi.input_type
class BridgePortArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[int] pvid: ort VLAN ID (pvid) specifies which VLAN the untagged ingress traffic is assigned to. This property only has effect when
        ...
        :param pulumi.Input[bool] auto_isolate: When enabled, prevents a port moving from discarding into forwarding state if no BPDUs are received from the neighboring
        ...
        :param pulumi.Input[bool] broadcast_flood: When enabled, bridge floods broadcast traffic to all bridge egress ports. When disabled, drops broadcast traffic on
               egress ports.
        :param pulumi.Input[str] edge: Set port as edge port or non-edge port, or enable edge discovery. Edge ports are connected to a LAN that has no other
               bridges attached.
        ...
        :param pulumi.Input[str] horizon: Use split horizon bridging to prevent bridging loops. Set the same value for group of ports, to prevent them from
        ...
        :param pulumi.Input[str] path_cost: Path cost to the interface, used by STP to determine the "best" path, used by MSTP todetermine "best" path between
               regions. This property has no effect when protocol-mode is set to none.
        :param pulumi.Input[str] point_to_point: Specifies if a bridge port is connected to a bridge using a point-to-point link for faster convergence in case of
               failure. This property has no effect when protocol-mode is set to none.
        :param pulumi.Input[str] priority: The priority of the interface, used by STP to determine the root port, used by MSTP to determine root port between
               regions.
        :param pulumi.Input[bool] restricted_role: Enable the restricted role on a port, used by STP to forbid a port becoming a root port. This property only has effect
               when protocol-mode is set to mstp.
        :param pulumi.Input[bool] restricted_tcn: Disable topology change notification (TCN) sending on a port, used by STP to forbid network topology changes to
               propagate. This property only has effect when protocol-mode is set to mstp.
        :param pulumi.Input[bool] tag_stacking: Forces all packets to be treated as untagged packets. Packets on ingress port will be tagged with another VLAN tag
        ...
        :param pulumi.Input[bool] trusted: When enabled, it allows to forward DHCP packets towards DHCP server through this port. Mainly used to limit unauthorized
...
class _BridgePortState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[int] port_number: Port number will be assigned in the order that ports got added to the bridge, but this is only true until reboot. After
        ...
        :param pulumi.Input[str] sending_rstp: Whether the port is sending RSTP or MSTP BPDU types. A port will transit to STP type when RSTP/MSTP enabled port
               receives a STP BPDU
...
class BridgePort(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__,
        ...
        ***
        ...
        :param str resource_name: The name of the resource.
        :param BridgePortArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(BridgePortArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = BridgePortArgs.__new__(BridgePortArgs)
        ...
        super(BridgePort, __self__).__init__(
    ...
    def get(resource_name: str,
            ...
            trusted: Optional[pulumi.Input[bool]] = None,
            unknown_multicast_flood: Optional[pulumi.Input[bool]] = None,
            unknown_unicast_flood: Optional[pulumi.Input[bool]] = None) -> 'BridgePort':
        """
        ...
        __props__ = _BridgePortState.__new__(_BridgePortState)
        ...
        __props__.__dict__["unknown_multicast_flood"] = unknown_multicast_flood
        __props__.__dict__["unknown_unicast_flood"] = unknown_unicast_flood
        return BridgePort(resource_name, opts=opts, __props__=__props__)
