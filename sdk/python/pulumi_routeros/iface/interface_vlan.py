...
__all__ = ['InterfaceVlanArgs', 'InterfaceVlan']
...
class InterfaceVlan(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(InterfaceVlanArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = InterfaceVlanArgs.__new__(InterfaceVlanArgs)
        ...
        super(InterfaceVlan, __self__).__init__(
    ...
    def get(resource_name: str,
            ...
            running: Optional[pulumi.Input[bool]] = None,
            use_service_tag: Optional[pulumi.Input[bool]] = None,
            vlan_id: Optional[pulumi.Input[int]] = None) -> 'InterfaceVlan':
        """
        ...
        __props__ = _InterfaceVlanState.__new__(_InterfaceVlanState)
        ...
        __props__.__dict__["use_service_tag"] = use_service_tag
        __props__.__dict__["vlan_id"] = vlan_id
        return InterfaceVlan(resource_name, opts=opts, __props__=__props__)
