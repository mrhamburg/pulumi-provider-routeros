...
__all__ = ['BridgeVlanArgs', 'BridgeVlan']

@pulumi.input_type
class BridgeVlanArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] vlan_ids: The list of VLAN IDs for certain port configuration. This setting accepts VLAN ID range as well as comma separated
        ...
        :param pulumi.Input[Sequence[pulumi.Input[str]]] taggeds: Interface list with a VLAN tag adding action in egress. This setting accepts comma separated values. E.g.
               tagged=ether1,ether2.
        :param pulumi.Input[Sequence[pulumi.Input[str]]] untaggeds: Interface list with a VLAN tag removing action in egress. This setting accepts comma separated values. E.g.
...
class BridgeVlan(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__,
        ...
        ***
        ...
        :param str resource_name: The name of the resource.
        :param BridgeVlanArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(BridgeVlanArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = BridgeVlanArgs.__new__(BridgeVlanArgs)
        ...
        super(BridgeVlan, __self__).__init__(
    ...
    def get(resource_name: str,
            ...
            taggeds: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
            untaggeds: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
            vlan_ids: Optional[pulumi.Input[str]] = None) -> 'BridgeVlan':
        """
        ...
        __props__ = _BridgeVlanState.__new__(_BridgeVlanState)
        ...
        __props__.__dict__["untaggeds"] = untaggeds
        __props__.__dict__["vlan_ids"] = vlan_ids
        return BridgeVlan(resource_name, opts=opts, __props__=__props__)
