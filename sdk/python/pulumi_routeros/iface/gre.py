...
class GreArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[bool] clamp_tcp_mss: Controls whether to change MSS size for received TCP SYN packets. When enabled, a router will change the MSS size for
        ...
        :param pulumi.Input[str] ipsec_secret: When secret is specified, router adds dynamic IPsec peer to remote-address with pre-shared key and policy (by default
               phase2 uses sha1/aes128cbc).
        :param pulumi.Input[str] keepalive: Tunnel keepalive parameter sets the time interval in which the tunnel running flag will remain even if the remote end of
...
class Gre(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__,
        ...
        ***
        ...
        :param str resource_name: The name of the resource.
        :param GreArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(GreArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = GreArgs.__new__(GreArgs)
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[str]] = None,
            remote_address: Optional[pulumi.Input[str]] = None,
            running: Optional[pulumi.Input[bool]] = None) -> 'Gre':
        """
        ...
        __props__ = _GreState.__new__(_GreState)
        ...
        return Gre(resource_name, opts=opts, __props__=__props__)
