...
class VrrpArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[bool] preemption_mode: Whether the master node always has the priority. When set to 'no' the backup node will not be elected to be a master
        ...
        :param pulumi.Input[int] priority: Priority of VRRP node used in Master election algorithm. A higher number means higher priority. '255' is reserved for
               the router that owns VR IP and '0' is reserved for the Master router to indicate that it is releasing responsibility.
        :param pulumi.Input[str] remote_address: Specifies the remote address of the other VRRP router for syncing connection tracking. If not set, the system
...
class Vrrp(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__,
        ...
        ***
        ...
        :param str resource_name: The name of the resource.
        :param VrrpArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(VrrpArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = VrrpArgs.__new__(VrrpArgs)
    ...
    def get(resource_name: str,
            ...
            v3_protocol: Optional[pulumi.Input[str]] = None,
            version: Optional[pulumi.Input[int]] = None,
            vrid: Optional[pulumi.Input[int]] = None) -> 'Vrrp':
        """
        ...
        __props__ = _VrrpState.__new__(_VrrpState)
        ...
        __props__.__dict__["version"] = version
        __props__.__dict__["vrid"] = vrid
        return Vrrp(resource_name, opts=opts, __props__=__props__)
