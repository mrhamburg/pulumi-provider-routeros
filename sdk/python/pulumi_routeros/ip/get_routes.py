...
def get_routes(___id_: Optional[int] = None,
    ...
    __ret__ = pulumi.runtime.invoke('routeros:Ip/getRoutes:getRoutes', __args__, opts=opts, typ=GetRoutesResult).value
...
def get_routes_output(___id_: Optional[pulumi.Input[Optional[int]]] = None,
