...
class IpDns(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param IpDnsArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(IpDnsArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = IpDnsArgs.__new__(IpDnsArgs)
    ...
    def get(resource_name: str,
            ...
            servers: Optional[pulumi.Input[str]] = None,
            use_doh_server: Optional[pulumi.Input[str]] = None,
            verify_doh_cert: Optional[pulumi.Input[bool]] = None) -> 'IpDns':
        """
        ...
        __props__ = _IpDnsState.__new__(_IpDnsState)
        ...
        __props__.__dict__["use_doh_server"] = use_doh_server
        __props__.__dict__["verify_doh_cert"] = verify_doh_cert
        return IpDns(resource_name, opts=opts, __props__=__props__)
