...
__all__ = ['DhcpServerNetworkArgs', 'DhcpServerNetwork']

@pulumi.input_type
class DhcpServerNetworkArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[bool] dns_none: If set, then DHCP Server will not pass dynamic DNS servers configured on the router to the DHCP clients if no DNS Server
               in DNS-server is set.
        :param pulumi.Input[str] dns_server: the DHCP client will use these as the default DNS servers. Two comma-separated DNS servers can be specified to be used
        ...
        :param pulumi.Input[str] ntp_server: The DHCP client will use these as the default NTP servers. Two comma-separated NTP servers can be specified to be used
               by the DHCP client as primary and secondary NTP servers
        :param pulumi.Input[str] wins_server: The Windows DHCP client will use these as the default WINS servers. Two comma-separated WINS servers can be specified to
...
class DhcpServerNetwork(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__,
        ...
        ***
        ...
        :param str resource_name: The name of the resource.
        :param DhcpServerNetworkArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(DhcpServerNetworkArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = DhcpServerNetworkArgs.__new__(DhcpServerNetworkArgs)
        ...
        super(DhcpServerNetwork, __self__).__init__(
    ...
    def get(resource_name: str,
            ...
            next_server: Optional[pulumi.Input[str]] = None,
            ntp_server: Optional[pulumi.Input[str]] = None,
            wins_server: Optional[pulumi.Input[str]] = None) -> 'DhcpServerNetwork':
        """
        ...
        __props__ = _DhcpServerNetworkState.__new__(_DhcpServerNetworkState)
        ...
        __props__.__dict__["ntp_server"] = ntp_server
        __props__.__dict__["wins_server"] = wins_server
        return DhcpServerNetwork(resource_name, opts=opts, __props__=__props__)
