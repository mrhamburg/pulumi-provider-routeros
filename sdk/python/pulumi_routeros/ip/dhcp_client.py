...
__all__ = ['DhcpClientArgs', 'DhcpClient']

@pulumi.input_type
class DhcpClientArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[bool] use_peer_ntp: Whether to accept the NTP settings advertised by DHCP Server (will override the settings put in the /system ntp client
               submenu).
        """
...
class DhcpClient(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__,
        ...
        ***
        ...
        :param str resource_name: The name of the resource.
        :param DhcpClientArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(DhcpClientArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = DhcpClientArgs.__new__(DhcpClientArgs)
        ...
        super(DhcpClient, __self__).__init__(
    ...
    def get(resource_name: str,
            ...
            status: Optional[pulumi.Input[str]] = None,
            use_peer_dns: Optional[pulumi.Input[bool]] = None,
            use_peer_ntp: Optional[pulumi.Input[bool]] = None) -> 'DhcpClient':
        """
        ...
        __props__ = _DhcpClientState.__new__(_DhcpClientState)
        ...
        __props__.__dict__["use_peer_dns"] = use_peer_dns
        __props__.__dict__["use_peer_ntp"] = use_peer_ntp
        return DhcpClient(resource_name, opts=opts, __props__=__props__)
