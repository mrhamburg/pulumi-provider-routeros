...
__all__ = ['ResourceDhcpClientArgs', 'ResourceDhcpClient']

@pulumi.input_type
class ResourceDhcpClientArgs:
...
@pulumi.input_type
class _ResourceDhcpClientState:
    def __init__(__self__, *,
                 ___id_: Optional[pulumi.Input[int]] = None,
                 ___path_: Optional[pulumi.Input[str]] = None,
                 add_default_route: Optional[pulumi.Input[str]] = None,
...
class ResourceDhcpClient(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
        ...
        client = routeros.ResourceDhcpClient("client", interface="bridge")
        ```
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param ResourceDhcpClientArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(ResourceDhcpClientArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = ResourceDhcpClientArgs.__new__(ResourceDhcpClientArgs)
        ...
        super(ResourceDhcpClient, __self__).__init__(
            'routeros:index/resourceDhcpClient:ResourceDhcpClient',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            status: Optional[pulumi.Input[str]] = None,
            use_peer_dns: Optional[pulumi.Input[bool]] = None,
            use_peer_ntp: Optional[pulumi.Input[bool]] = None) -> 'ResourceDhcpClient':
        """
        ...
        __props__ = _ResourceDhcpClientState.__new__(_ResourceDhcpClientState)
        ...
        __props__.__dict__["use_peer_dns"] = use_peer_dns
        __props__.__dict__["use_peer_ntp"] = use_peer_ntp
        return ResourceDhcpClient(resource_name, opts=opts, __props__=__props__)
