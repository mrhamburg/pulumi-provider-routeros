...
1. Run the following command to update files to use the name of your provider (third-party: use your GitHub organization/username):
   ...
   - find and replace all instances of the boilerplate `routeros` with the `NAME` of your provider.
...
before:
  ...
  - make tfgen
builds:
- binary: pulumi-resource-routeros
  dir: provider
  goarch:
  - amd64
  - arm64
  ...
  ignore: []
  ldflags:
  - -X github.com/mrhamburg/pulumi-provider-routeros/provider/pkg/version.Version={{.Tag}}
  main: ./cmd/pulumi-resource-routeros/
  sort: asc
  use: git
release:
  disable: false
...
├── config.yaml
├── metadata.json
├── pulumi-routeros_darwin_amd64_v1
│   └── pulumi-resource-routeros
├── pulumi-routeros_darwin_arm64
│   └── pulumi-resource-routeros
├── pulumi-routeros_linux_amd64_v1
│   └── pulumi-resource-routeros
├── pulumi-routeros_linux_arm64
│   └── pulumi-resource-routeros
├── pulumi-routeros_windows_amd64_v1
│   └── pulumi-resource-routeros.exe
└── pulumi-routeros_windows_arm64
    └── pulumi-resource-routeros.exe
```
