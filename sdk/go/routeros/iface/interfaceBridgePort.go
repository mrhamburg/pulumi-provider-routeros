...
func NewInterfaceBridgePort(ctx *pulumi.Context,
	...
	var resource InterfaceBridgePort
	err := ctx.RegisterResource("routeros:Iface/interfaceBridgePort:InterfaceBridgePort", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// GetInterfaceBridgePort gets an existing InterfaceBridgePort resource's state with the given name, ID, and optional
...
func GetInterfaceBridgePort(ctx *pulumi.Context,
	...
	var resource InterfaceBridgePort
	err := ctx.ReadResource("routeros:Iface/interfaceBridgePort:InterfaceBridgePort", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func (InterfaceBridgePortState) ElementType() reflect.Type {
	return reflect.TypeOf((*interfaceBridgePortState)(nil)).Elem()
}
...
func (InterfaceBridgePortArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*interfaceBridgePortArgs)(nil)).Elem()
}
...
func (*InterfaceBridgePort) ElementType() reflect.Type {
	return reflect.TypeOf((**InterfaceBridgePort)(nil)).Elem()
}

func (i *InterfaceBridgePort) ToInterfaceBridgePortOutput() InterfaceBridgePortOutput {
	return i.ToInterfaceBridgePortOutputWithContext(context.Background())
}

func (i *InterfaceBridgePort) ToInterfaceBridgePortOutputWithContext(ctx context.Context) InterfaceBridgePortOutput {
	return pulumi.ToOutputWithContext(ctx, i).(InterfaceBridgePortOutput)
}

// InterfaceBridgePortArrayInput is an input type that accepts InterfaceBridgePortArray and InterfaceBridgePortArrayOutput values.
// You can construct a concrete instance of `InterfaceBridgePortArrayInput` via:
//
...
func (i InterfaceBridgePortArray) ToInterfaceBridgePortArrayOutput() InterfaceBridgePortArrayOutput {
	return i.ToInterfaceBridgePortArrayOutputWithContext(context.Background())
}
...
func (i InterfaceBridgePortArray) ToInterfaceBridgePortArrayOutputWithContext(ctx context.Context) InterfaceBridgePortArrayOutput {
	return pulumi.ToOutputWithContext(ctx, i).(InterfaceBridgePortArrayOutput)
}

// InterfaceBridgePortMapInput is an input type that accepts InterfaceBridgePortMap and InterfaceBridgePortMapOutput values.
// You can construct a concrete instance of `InterfaceBridgePortMapInput` via:
//
...
// <em>Resource ID type (.id / name). This is an internal service field, setting a value is not required.</em>
func (o InterfaceBridgePortOutput) ___id_() pulumi.IntPtrOutput {
	return o.ApplyT(func(v *InterfaceBridgePort) pulumi.IntPtrOutput { return v.___id_ }).(pulumi.IntPtrOutput)
}

// <em>Resource path for CRUD operations. This is an internal service field, setting a value is not required.</em>
func (o InterfaceBridgePortOutput) ___path_() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *InterfaceBridgePort) pulumi.StringPtrOutput { return v.___path_ }).(pulumi.StringPtrOutput)
}

// When enabled, prevents a port moving from discarding into forwarding state if no BPDUs are received from the neighboring bridge. The port will change into a forwarding state only when a BPDU is received. This property only has an effect when protocol-mode is set to rstp or mstp and edge is set to no.
func (o InterfaceBridgePortOutput) AutoIsolate() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v *InterfaceBridgePort) pulumi.BoolPtrOutput { return v.AutoIsolate }).(pulumi.BoolPtrOutput)
}

// This property has no effect when protocol-mode is set to none.
func (o InterfaceBridgePortOutput) BpduGuard() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v *InterfaceBridgePort) pulumi.BoolPtrOutput { return v.BpduGuard }).(pulumi.BoolPtrOutput)
}

func (o InterfaceBridgePortOutput) Bridge() pulumi.StringOutput {
	return o.ApplyT(func(v *InterfaceBridgePort) pulumi.StringOutput { return v.Bridge }).(pulumi.StringOutput)
}

// When enabled, bridge floods broadcast traffic to all bridge egress ports. When disabled, drops broadcast traffic on egress ports.
func (o InterfaceBridgePortOutput) BroadcastFlood() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v *InterfaceBridgePort) pulumi.BoolPtrOutput { return v.BroadcastFlood }).(pulumi.BoolPtrOutput)
}

func (o InterfaceBridgePortOutput) Comment() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *InterfaceBridgePort) pulumi.StringPtrOutput { return v.Comment }).(pulumi.StringPtrOutput)
}

func (o InterfaceBridgePortOutput) DebugInfo() pulumi.StringOutput {
	return o.ApplyT(func(v *InterfaceBridgePort) pulumi.StringOutput { return v.DebugInfo }).(pulumi.StringOutput)
}

// Root bridge ID (bridge priority and the bridge MAC address).
func (o InterfaceBridgePortOutput) DesignatedBridge() pulumi.StringOutput {
	return o.ApplyT(func(v *InterfaceBridgePort) pulumi.StringOutput { return v.DesignatedBridge }).(pulumi.StringOutput)
}

// Designated cost.
func (o InterfaceBridgePortOutput) DesignatedCost() pulumi.StringOutput {
	return o.ApplyT(func(v *InterfaceBridgePort) pulumi.StringOutput { return v.DesignatedCost }).(pulumi.StringOutput)
}

// Designated port number.
func (o InterfaceBridgePortOutput) DesignatedPortNumber() pulumi.IntOutput {
	return o.ApplyT(func(v *InterfaceBridgePort) pulumi.IntOutput { return v.DesignatedPortNumber }).(pulumi.IntOutput)
}

func (o InterfaceBridgePortOutput) Disabled() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v *InterfaceBridgePort) pulumi.BoolPtrOutput { return v.Disabled }).(pulumi.BoolPtrOutput)
}

// Configuration item created by software, not by management interface. It is not exported, and cannot be directly modified.
func (o InterfaceBridgePortOutput) Dynamic() pulumi.BoolOutput {
	return o.ApplyT(func(v *InterfaceBridgePort) pulumi.BoolOutput { return v.Dynamic }).(pulumi.BoolOutput)
}

// Set port as edge port or non-edge port, or enable edge discovery. Edge ports are connected to a LAN that has no other bridges attached.
func (o InterfaceBridgePortOutput) Edge() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *InterfaceBridgePort) pulumi.StringPtrOutput { return v.Edge }).(pulumi.StringPtrOutput)
}

// Whether port is an edge port or not.
func (o InterfaceBridgePortOutput) EdgePort() pulumi.BoolOutput {
	return o.ApplyT(func(v *InterfaceBridgePort) pulumi.BoolOutput { return v.EdgePort }).(pulumi.BoolOutput)
}

// Whether port is set to automatically detect edge ports.
func (o InterfaceBridgePortOutput) EdgePortDiscovery() pulumi.BoolOutput {
	return o.ApplyT(func(v *InterfaceBridgePort) pulumi.BoolOutput { return v.EdgePortDiscovery }).(pulumi.BoolOutput)
}

// Whether registration table is used instead of forwarding data base.
func (o InterfaceBridgePortOutput) ExternalFdbStatus() pulumi.BoolOutput {
	return o.ApplyT(func(v *InterfaceBridgePort) pulumi.BoolOutput { return v.ExternalFdbStatus }).(pulumi.BoolOutput)
}

// Enables IGMP Fast leave feature on the port.
func (o InterfaceBridgePortOutput) FastLeave() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v *InterfaceBridgePort) pulumi.BoolPtrOutput { return v.FastLeave }).(pulumi.BoolPtrOutput)
}

// Shows if the port is not blocked by (R/M)STP.
func (o InterfaceBridgePortOutput) Forwarding() pulumi.BoolOutput {
	return o.ApplyT(func(v *InterfaceBridgePort) pulumi.BoolOutput { return v.Forwarding }).(pulumi.BoolOutput)
}

// Specifies allowed ingress frame types on a bridge port. This property only has effect when vlan-filtering is set to yes.
func (o InterfaceBridgePortOutput) FrameTypes() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *InterfaceBridgePort) pulumi.StringPtrOutput { return v.FrameTypes }).(pulumi.StringPtrOutput)
}

// Use split horizon bridging to prevent bridging loops. Set the same value for group of ports, to prevent them from sending data to ports with the same horizon value. Split horizon is a software feature that disables hardware offloading. This value is integer '0'..'429496729' or 'none'.
func (o InterfaceBridgePortOutput) Horizon() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *InterfaceBridgePort) pulumi.StringPtrOutput { return v.Horizon }).(pulumi.StringPtrOutput)
}

// Enable or disable Hardware Offloading of the interface.
func (o InterfaceBridgePortOutput) Hw() pulumi.BoolOutput {
	return o.ApplyT(func(v *InterfaceBridgePort) pulumi.BoolOutput { return v.Hw }).(pulumi.BoolOutput)
}

// Hardware offloading state.
func (o InterfaceBridgePortOutput) HwOffload() pulumi.BoolOutput {
	return o.ApplyT(func(v *InterfaceBridgePort) pulumi.BoolOutput { return v.HwOffload }).(pulumi.BoolOutput)
}

// Switch chip used by the port.
func (o InterfaceBridgePortOutput) HwOffloadGroup() pulumi.StringOutput {
	return o.ApplyT(func(v *InterfaceBridgePort) pulumi.StringOutput { return v.HwOffloadGroup }).(pulumi.StringOutput)
}

func (o InterfaceBridgePortOutput) Inactive() pulumi.BoolOutput {
	return o.ApplyT(func(v *InterfaceBridgePort) pulumi.BoolOutput { return v.Inactive }).(pulumi.BoolOutput)
}

// Enables or disables VLAN ingress filtering, which checks if the ingress port is a member of the received VLAN ID in the bridge VLAN table. Should be used with frame-types to specify if the ingress traffic should be tagged or untagged. This property only has effect when vlan-filtering is set to yes.
func (o InterfaceBridgePortOutput) IngressFiltering() pulumi.BoolOutput {
	return o.ApplyT(func(v *InterfaceBridgePort) pulumi.BoolOutput { return v.IngressFiltering }).(pulumi.BoolOutput)
}

// Name of the interface.
func (o InterfaceBridgePortOutput) Interface() pulumi.StringOutput {
	return o.ApplyT(func(v *InterfaceBridgePort) pulumi.StringOutput { return v.Interface }).(pulumi.StringOutput)
}

// Path cost to the interface for MSTI0 inside a region. This property only has effect when protocol-mode is set to mstp.
func (o InterfaceBridgePortOutput) InternalPathCost() pulumi.IntPtrOutput {
	return o.ApplyT(func(v *InterfaceBridgePort) pulumi.IntPtrOutput { return v.InternalPathCost }).(pulumi.IntPtrOutput)
}

// Changes MAC learning behaviour on a bridge port
func (o InterfaceBridgePortOutput) Learn() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *InterfaceBridgePort) pulumi.StringPtrOutput { return v.Learn }).(pulumi.StringPtrOutput)
}

// Shows whether the port is capable of learning MAC addresses.
func (o InterfaceBridgePortOutput) Learning() pulumi.BoolOutput {
	return o.ApplyT(func(v *InterfaceBridgePort) pulumi.BoolOutput { return v.Learning }).(pulumi.BoolOutput)
}

// Changes the state of a bridge port whether IGMP membership reports are going to be forwarded to this port.
func (o InterfaceBridgePortOutput) MulticastRouter() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *InterfaceBridgePort) pulumi.StringPtrOutput { return v.MulticastRouter }).(pulumi.StringPtrOutput)
}

func (o InterfaceBridgePortOutput) Nextid() pulumi.StringOutput {
	return o.ApplyT(func(v *InterfaceBridgePort) pulumi.StringOutput { return v.Nextid }).(pulumi.StringOutput)
}

// Path cost to the interface, used by STP to determine the "best" path, used by MSTP todetermine "best" path between regions. This property has no effect when protocol-mode is set to none.
func (o InterfaceBridgePortOutput) PathCost() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *InterfaceBridgePort) pulumi.StringPtrOutput { return v.PathCost }).(pulumi.StringPtrOutput)
}

// Specifies if a bridge port is connected to a bridge using a point-to-point link for faster convergence in case of failure. This property has no effect when protocol-mode is set to none.
func (o InterfaceBridgePortOutput) PointToPoint() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *InterfaceBridgePort) pulumi.StringPtrOutput { return v.PointToPoint }).(pulumi.StringPtrOutput)
}

// Whether the port is connected to a bridge port using full-duplex (true) or half-duplex (false).
func (o InterfaceBridgePortOutput) PointToPointPort() pulumi.BoolOutput {
	return o.ApplyT(func(v *InterfaceBridgePort) pulumi.BoolOutput { return v.PointToPointPort }).(pulumi.BoolOutput)
}

// Port number will be assigned in the order that ports got added to the bridge, but this is only true until reboot. After reboot internal numbering will be used.
func (o InterfaceBridgePortOutput) PortNumber() pulumi.IntOutput {
	return o.ApplyT(func(v *InterfaceBridgePort) pulumi.IntOutput { return v.PortNumber }).(pulumi.IntOutput)
}

// The priority of the interface, used by STP to determine the root port, used by MSTP to determine root port between regions.
func (o InterfaceBridgePortOutput) Priority() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *InterfaceBridgePort) pulumi.StringPtrOutput { return v.Priority }).(pulumi.StringPtrOutput)
}

// ort VLAN ID (pvid) specifies which VLAN the untagged ingress traffic is assigned to. This property only has effect when vlan-filtering is set to yes.
func (o InterfaceBridgePortOutput) Pvid() pulumi.IntOutput {
	return o.ApplyT(func(v *InterfaceBridgePort) pulumi.IntOutput { return v.Pvid }).(pulumi.IntOutput)
}

// Enable the restricted role on a port, used by STP to forbid a port becoming a root port. This property only has effect when protocol-mode is set to mstp.
func (o InterfaceBridgePortOutput) RestrictedRole() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v *InterfaceBridgePort) pulumi.BoolPtrOutput { return v.RestrictedRole }).(pulumi.BoolPtrOutput)
}

// Disable topology change notification (TCN) sending on a port, used by STP to forbid network topology changes to propagate. This property only has effect when protocol-mode is set to mstp.
func (o InterfaceBridgePortOutput) RestrictedTcn() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v *InterfaceBridgePort) pulumi.BoolPtrOutput { return v.RestrictedTcn }).(pulumi.BoolPtrOutput)
}

// (R/M)STP algorithm assigned role of the port
func (o InterfaceBridgePortOutput) Role() pulumi.StringOutput {
	return o.ApplyT(func(v *InterfaceBridgePort) pulumi.StringOutput { return v.Role }).(pulumi.StringOutput)
}

// The total cost of the path to the root-bridge.
func (o InterfaceBridgePortOutput) RootPathCost() pulumi.IntOutput {
	return o.ApplyT(func(v *InterfaceBridgePort) pulumi.IntOutput { return v.RootPathCost }).(pulumi.IntOutput)
}

// Whether the port is sending RSTP or MSTP BPDU types. A port will transit to STP type when RSTP/MSTP enabled port receives a STP BPDU
func (o InterfaceBridgePortOutput) SendingRstp() pulumi.StringOutput {
	return o.ApplyT(func(v *InterfaceBridgePort) pulumi.StringOutput { return v.SendingRstp }).(pulumi.StringOutput)
}

// Port status ('in-bridge' - port is enabled).
func (o InterfaceBridgePortOutput) Status() pulumi.StringOutput {
	return o.ApplyT(func(v *InterfaceBridgePort) pulumi.StringOutput { return v.Status }).(pulumi.StringOutput)
}

// Forces all packets to be treated as untagged packets. Packets on ingress port will be tagged with another VLAN tag regardless if a VLAN tag already exists, packets will be tagged with a VLAN ID that matches the pvid value and will use EtherType that is specified in ether-type. This property only has effect when vlan-filtering is set to yes.
func (o InterfaceBridgePortOutput) TagStacking() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v *InterfaceBridgePort) pulumi.BoolPtrOutput { return v.TagStacking }).(pulumi.BoolPtrOutput)
}

// When enabled, it allows to forward DHCP packets towards DHCP server through this port. Mainly used to limit unauthorized servers to provide malicious information for users. This property only has effect when dhcp-snooping is set to yes.
func (o InterfaceBridgePortOutput) Trusted() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v *InterfaceBridgePort) pulumi.BoolPtrOutput { return v.Trusted }).(pulumi.BoolPtrOutput)
}

// When enabled, bridge floods unknown multicast traffic to all bridge egress ports.
func (o InterfaceBridgePortOutput) UnknownMulticastFlood() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v *InterfaceBridgePort) pulumi.BoolPtrOutput { return v.UnknownMulticastFlood }).(pulumi.BoolPtrOutput)
}

// When enabled, bridge floods unknown unicast traffic to all bridge egress ports.
func (o InterfaceBridgePortOutput) UnknownUnicastFlood() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v *InterfaceBridgePort) pulumi.BoolPtrOutput { return v.UnknownUnicastFlood }).(pulumi.BoolPtrOutput)
}

type InterfaceBridgePortArrayOutput struct{ *pulumi.OutputState }

func (InterfaceBridgePortArrayOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*[]*InterfaceBridgePort)(nil)).Elem()
}
...
func (o InterfaceBridgePortArrayOutput) Index(i pulumi.IntInput) InterfaceBridgePortOutput {
	return pulumi.All(o, i).ApplyT(func(vs []interface{}) *InterfaceBridgePort {
		return vs[0].([]*InterfaceBridgePort)[vs[1].(int)]
	}).(InterfaceBridgePortOutput)
}

type InterfaceBridgePortMapOutput struct{ *pulumi.OutputState }

func (InterfaceBridgePortMapOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*map[string]*InterfaceBridgePort)(nil)).Elem()
}
...
func (o InterfaceBridgePortMapOutput) MapIndex(k pulumi.StringInput) InterfaceBridgePortOutput {
	return pulumi.All(o, k).ApplyT(func(vs []interface{}) *InterfaceBridgePort {
		return vs[0].(map[string]*InterfaceBridgePort)[vs[1].(string)]
	}).(InterfaceBridgePortOutput)
}

func init() {
	pulumi.RegisterInputType(reflect.TypeOf((*InterfaceBridgePortInput)(nil)).Elem(), &InterfaceBridgePort{})
	pulumi.RegisterInputType(reflect.TypeOf((*InterfaceBridgePortArrayInput)(nil)).Elem(), InterfaceBridgePortArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*InterfaceBridgePortMapInput)(nil)).Elem(), InterfaceBridgePortMap{})
	pulumi.RegisterOutputType(InterfaceBridgePortOutput{})
	pulumi.RegisterOutputType(InterfaceBridgePortArrayOutput{})
	pulumi.RegisterOutputType(InterfaceBridgePortMapOutput{})
}
