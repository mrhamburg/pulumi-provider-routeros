...
func NewRoute(ctx *pulumi.Context,
	...
	var resource Route
	err := ctx.RegisterResource("routeros:Ip/route:Route", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRoute(ctx *pulumi.Context,
	...
	var resource Route
	err := ctx.ReadResource("routeros:Ip/route:Route", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func (o RouteOutput) CheckGateway() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *Route) pulumi.StringPtrOutput { return v.CheckGateway }).(pulumi.StringPtrOutput)
}
...
func (o RouteOutput) Dhcp() pulumi.BoolOutput {
	return o.ApplyT(func(v *Route) pulumi.BoolOutput { return v.Dhcp }).(pulumi.BoolOutput)
}
...
func (o RouteOutput) DstAddress() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *Route) pulumi.StringPtrOutput { return v.DstAddress }).(pulumi.StringPtrOutput)
}
