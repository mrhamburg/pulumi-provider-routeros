...
func NewIpFirewallFilter(ctx *pulumi.Context,
	...
	var resource IpFirewallFilter
	err := ctx.RegisterResource("routeros:Ip/ipFirewallFilter:IpFirewallFilter", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// GetIpFirewallFilter gets an existing IpFirewallFilter resource's state with the given name, ID, and optional
...
func GetIpFirewallFilter(ctx *pulumi.Context,
	...
	var resource IpFirewallFilter
	err := ctx.ReadResource("routeros:Ip/ipFirewallFilter:IpFirewallFilter", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func (IpFirewallFilterState) ElementType() reflect.Type {
	return reflect.TypeOf((*ipFirewallFilterState)(nil)).Elem()
}
...
func (IpFirewallFilterArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*ipFirewallFilterArgs)(nil)).Elem()
}
...
func (*IpFirewallFilter) ElementType() reflect.Type {
	return reflect.TypeOf((**IpFirewallFilter)(nil)).Elem()
}

func (i *IpFirewallFilter) ToIpFirewallFilterOutput() IpFirewallFilterOutput {
	return i.ToIpFirewallFilterOutputWithContext(context.Background())
}

func (i *IpFirewallFilter) ToIpFirewallFilterOutputWithContext(ctx context.Context) IpFirewallFilterOutput {
	return pulumi.ToOutputWithContext(ctx, i).(IpFirewallFilterOutput)
}

// IpFirewallFilterArrayInput is an input type that accepts IpFirewallFilterArray and IpFirewallFilterArrayOutput values.
// You can construct a concrete instance of `IpFirewallFilterArrayInput` via:
//
...
func (i IpFirewallFilterArray) ToIpFirewallFilterArrayOutput() IpFirewallFilterArrayOutput {
	return i.ToIpFirewallFilterArrayOutputWithContext(context.Background())
}

func (i IpFirewallFilterArray) ToIpFirewallFilterArrayOutputWithContext(ctx context.Context) IpFirewallFilterArrayOutput {
	return pulumi.ToOutputWithContext(ctx, i).(IpFirewallFilterArrayOutput)
}

// IpFirewallFilterMapInput is an input type that accepts IpFirewallFilterMap and IpFirewallFilterMapOutput values.
// You can construct a concrete instance of `IpFirewallFilterMapInput` via:
//
...
// <em>Resource ID type (.id / name). This is an internal service field, setting a value is not required.</em>
func (o IpFirewallFilterOutput) ___id_() pulumi.IntPtrOutput {
	return o.ApplyT(func(v *IpFirewallFilter) pulumi.IntPtrOutput { return v.___id_ }).(pulumi.IntPtrOutput)
}

// <em>Resource path for CRUD operations. This is an internal service field, setting a value is not required.</em>
func (o IpFirewallFilterOutput) ___path_() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *IpFirewallFilter) pulumi.StringPtrOutput { return v.___path_ }).(pulumi.StringPtrOutput)
}

// Action to take if a packet is matched by the rule
func (o IpFirewallFilterOutput) Action() pulumi.StringOutput {
	return o.ApplyT(func(v *IpFirewallFilter) pulumi.StringOutput { return v.Action }).(pulumi.StringOutput)
}

// Time interval after which the address will be removed from the address list specified by address-list parameter. Used in
// conjunction with add-dst-to-address-list or add-src-to-address-list actions.
func (o IpFirewallFilterOutput) AddressListTimeout() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *IpFirewallFilter) pulumi.StringPtrOutput { return v.AddressListTimeout }).(pulumi.StringPtrOutput)
}

// The total amount of bytes matched by the rule.
func (o IpFirewallFilterOutput) Bytes() pulumi.IntOutput {
	return o.ApplyT(func(v *IpFirewallFilter) pulumi.IntOutput { return v.Bytes }).(pulumi.IntOutput)
}

// Specifies to which chain rule will be added. If the input does not match the name of an already defined chain, a new
// chain will be created.
func (o IpFirewallFilterOutput) Chain() pulumi.StringOutput {
	return o.ApplyT(func(v *IpFirewallFilter) pulumi.StringOutput { return v.Chain }).(pulumi.StringOutput)
}

func (o IpFirewallFilterOutput) Comment() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *IpFirewallFilter) pulumi.StringPtrOutput { return v.Comment }).(pulumi.StringPtrOutput)
}

// Matches packets only if a given amount of bytes has been transfered through the particular connection.
func (o IpFirewallFilterOutput) ConnectionBytes() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *IpFirewallFilter) pulumi.StringPtrOutput { return v.ConnectionBytes }).(pulumi.StringPtrOutput)
}

// Matches connections per address or address block after given value is reached. Should be used together with
// connection-state=new and/or with tcp-flags=syn because matcher is very resource intensive.
func (o IpFirewallFilterOutput) ConnectionLimit() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *IpFirewallFilter) pulumi.StringPtrOutput { return v.ConnectionLimit }).(pulumi.StringPtrOutput)
}

// Matches packets marked via mangle facility with particular connection mark. If no-mark is set, rule will match any
// unmarked connection.
func (o IpFirewallFilterOutput) ConnectionMark() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *IpFirewallFilter) pulumi.StringPtrOutput { return v.ConnectionMark }).(pulumi.StringPtrOutput)
}

// Can match connections that are srcnatted, dstnatted or both.
func (o IpFirewallFilterOutput) ConnectionNatState() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *IpFirewallFilter) pulumi.StringPtrOutput { return v.ConnectionNatState }).(pulumi.StringPtrOutput)
}

// Connection Rate is a firewall matcher that allow to capture traffic based on present speed of the connection
// (0..4294967295).
func (o IpFirewallFilterOutput) ConnectionRate() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *IpFirewallFilter) pulumi.StringPtrOutput { return v.ConnectionRate }).(pulumi.StringPtrOutput)
}

// Interprets the connection tracking analysis data for a particular packet.
func (o IpFirewallFilterOutput) ConnectionState() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *IpFirewallFilter) pulumi.StringPtrOutput { return v.ConnectionState }).(pulumi.StringPtrOutput)
}

// Matches packets from related connections based on information from their connection tracking helpers.
func (o IpFirewallFilterOutput) ConnectionType() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *IpFirewallFilter) pulumi.StringPtrOutput { return v.ConnectionType }).(pulumi.StringPtrOutput)
}

// Match packets that contain specified text.
func (o IpFirewallFilterOutput) Content() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *IpFirewallFilter) pulumi.StringPtrOutput { return v.Content }).(pulumi.StringPtrOutput)
}

func (o IpFirewallFilterOutput) Disabled() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v *IpFirewallFilter) pulumi.BoolPtrOutput { return v.Disabled }).(pulumi.BoolPtrOutput)
}

// Matches DSCP IP header field.
func (o IpFirewallFilterOutput) Dscp() pulumi.IntPtrOutput {
	return o.ApplyT(func(v *IpFirewallFilter) pulumi.IntPtrOutput { return v.Dscp }).(pulumi.IntPtrOutput)
}

// Matches packets which destination is equal to specified IP or falls into specified IP range.
func (o IpFirewallFilterOutput) DstAddress() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *IpFirewallFilter) pulumi.StringPtrOutput { return v.DstAddress }).(pulumi.StringPtrOutput)
}

// Matches destination address of a packet against user-defined address list.
func (o IpFirewallFilterOutput) DstAddressList() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *IpFirewallFilter) pulumi.StringPtrOutput { return v.DstAddressList }).(pulumi.StringPtrOutput)
}

// Matches destination address type.
func (o IpFirewallFilterOutput) DstAddressType() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *IpFirewallFilter) pulumi.StringPtrOutput { return v.DstAddressType }).(pulumi.StringPtrOutput)
}

// Matches packets until a given rate is exceeded.
func (o IpFirewallFilterOutput) DstLimit() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *IpFirewallFilter) pulumi.StringPtrOutput { return v.DstLimit }).(pulumi.StringPtrOutput)
}

// List of destination port numbers or port number ranges.
func (o IpFirewallFilterOutput) DstPort() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *IpFirewallFilter) pulumi.StringPtrOutput { return v.DstPort }).(pulumi.StringPtrOutput)
}

// Configuration item created by software, not by management interface. It is not exported, and cannot be directly
// modified.
func (o IpFirewallFilterOutput) Dynamic() pulumi.BoolOutput {
	return o.ApplyT(func(v *IpFirewallFilter) pulumi.BoolOutput { return v.Dynamic }).(pulumi.BoolOutput)
}

// Matches fragmented packets. First (starting) fragment does not count. If connection tracking is enabled there will be no
// fragments as system automatically assembles every packet
func (o IpFirewallFilterOutput) Fragment() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v *IpFirewallFilter) pulumi.BoolPtrOutput { return v.Fragment }).(pulumi.BoolPtrOutput)
}

// Matches packets received from HotSpot clients against various HotSpot matchers.
func (o IpFirewallFilterOutput) Hotspot() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *IpFirewallFilter) pulumi.StringPtrOutput { return v.Hotspot }).(pulumi.StringPtrOutput)
}

// Connection offloading for Fasttrack.
func (o IpFirewallFilterOutput) HwOffload() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v *IpFirewallFilter) pulumi.BoolPtrOutput { return v.HwOffload }).(pulumi.BoolPtrOutput)
}

// Matches ICMP type: code fields.
func (o IpFirewallFilterOutput) IcmpOptions() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *IpFirewallFilter) pulumi.StringPtrOutput { return v.IcmpOptions }).(pulumi.StringPtrOutput)
}

// Actual interface the packet has entered the router if the incoming interface is a bridge. Works only if use-ip-firewall
// is enabled in bridge settings.
func (o IpFirewallFilterOutput) InBridgePort() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *IpFirewallFilter) pulumi.StringPtrOutput { return v.InBridgePort }).(pulumi.StringPtrOutput)
}

// Set of interfaces defined in interface list. Works the same as in-bridge-port.
func (o IpFirewallFilterOutput) InBridgePortList() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *IpFirewallFilter) pulumi.StringPtrOutput { return v.InBridgePortList }).(pulumi.StringPtrOutput)
}

// Interface the packet has entered the router.
func (o IpFirewallFilterOutput) InInterface() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *IpFirewallFilter) pulumi.StringPtrOutput { return v.InInterface }).(pulumi.StringPtrOutput)
}

// Set of interfaces defined in interface list. Works the same as in-interface.
func (o IpFirewallFilterOutput) InInterfaceList() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *IpFirewallFilter) pulumi.StringPtrOutput { return v.InInterfaceList }).(pulumi.StringPtrOutput)
}

// Matches the priority of an ingress packet. Priority may be derived from VLAN, WMM, DSCP, or MPLS EXP bit.
func (o IpFirewallFilterOutput) IngressPriority() pulumi.IntPtrOutput {
	return o.ApplyT(func(v *IpFirewallFilter) pulumi.IntPtrOutput { return v.IngressPriority }).(pulumi.IntPtrOutput)
}

func (o IpFirewallFilterOutput) Invalid() pulumi.BoolOutput {
	return o.ApplyT(func(v *IpFirewallFilter) pulumi.BoolOutput { return v.Invalid }).(pulumi.BoolOutput)
}

// Matches the policy used by IPsec. Value is written in the following format: direction, policy.
func (o IpFirewallFilterOutput) IpsecPolicy() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *IpFirewallFilter) pulumi.StringPtrOutput { return v.IpsecPolicy }).(pulumi.StringPtrOutput)
}

// Matches IPv4 header options.
func (o IpFirewallFilterOutput) Ipv4Options() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *IpFirewallFilter) pulumi.StringPtrOutput { return v.Ipv4Options }).(pulumi.StringPtrOutput)
}

// Name of the target chain to jump to. Applicable only if action=jump.
func (o IpFirewallFilterOutput) JumpTarget() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *IpFirewallFilter) pulumi.StringPtrOutput { return v.JumpTarget }).(pulumi.StringPtrOutput)
}

// Layer7 filter name.
func (o IpFirewallFilterOutput) Layer7Protocol() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *IpFirewallFilter) pulumi.StringPtrOutput { return v.Layer7Protocol }).(pulumi.StringPtrOutput)
}

// Matches packets up to a limited rate (packet rate or bit rate). A rule using this matcher will match until this limit is
// reached. Parameters are written in the following format: rate[/time],burst:mode.
func (o IpFirewallFilterOutput) Limit() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *IpFirewallFilter) pulumi.StringPtrOutput { return v.Limit }).(pulumi.StringPtrOutput)
}

// Add a message to the system log.
func (o IpFirewallFilterOutput) Log() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v *IpFirewallFilter) pulumi.BoolPtrOutput { return v.Log }).(pulumi.BoolPtrOutput)
}

// Adds specified text at the beginning of every log message. Applicable if action=log or log=yes configured.
func (o IpFirewallFilterOutput) LogPrefix() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *IpFirewallFilter) pulumi.StringPtrOutput { return v.LogPrefix }).(pulumi.StringPtrOutput)
}

// Matches every nth packet: nth=2,1 rule will match every first packet of 2, hence, 50% of all the traffic that is matched
// by the rule
func (o IpFirewallFilterOutput) Nth() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *IpFirewallFilter) pulumi.StringPtrOutput { return v.Nth }).(pulumi.StringPtrOutput)
}

// Actual interface the packet is leaving the router if the outgoing interface is a bridge. Works only if use-ip-firewall
// is enabled in bridge settings.
func (o IpFirewallFilterOutput) OutBridgePort() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *IpFirewallFilter) pulumi.StringPtrOutput { return v.OutBridgePort }).(pulumi.StringPtrOutput)
}

// Set of interfaces defined in interface list. Works the same as out-bridge-port.
func (o IpFirewallFilterOutput) OutBridgePortList() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *IpFirewallFilter) pulumi.StringPtrOutput { return v.OutBridgePortList }).(pulumi.StringPtrOutput)
}

// Interface the packet is leaving the router.
func (o IpFirewallFilterOutput) OutInterface() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *IpFirewallFilter) pulumi.StringPtrOutput { return v.OutInterface }).(pulumi.StringPtrOutput)
}

// Set of interfaces defined in interface list. Works the same as out-interface.
func (o IpFirewallFilterOutput) OutInterfaceList() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *IpFirewallFilter) pulumi.StringPtrOutput { return v.OutInterfaceList }).(pulumi.StringPtrOutput)
}

// Matches packets marked via mangle facility with particular packet mark. If no-mark is set, the rule will match any
// unmarked packet.
func (o IpFirewallFilterOutput) PacketMark() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *IpFirewallFilter) pulumi.StringPtrOutput { return v.PacketMark }).(pulumi.StringPtrOutput)
}

// Matches packets of specified size or size range in bytes.
func (o IpFirewallFilterOutput) PacketSize() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *IpFirewallFilter) pulumi.StringPtrOutput { return v.PacketSize }).(pulumi.StringPtrOutput)
}

// The total amount of packets matched by the rule.
func (o IpFirewallFilterOutput) Packets() pulumi.IntOutput {
	return o.ApplyT(func(v *IpFirewallFilter) pulumi.IntOutput { return v.Packets }).(pulumi.IntOutput)
}

// PCC matcher allows dividing traffic into equal streams with the ability to keep packets with a specific set of options
// in one particular stream.
func (o IpFirewallFilterOutput) PerConnectionClassifier() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *IpFirewallFilter) pulumi.StringPtrOutput { return v.PerConnectionClassifier }).(pulumi.StringPtrOutput)
}

// Before which position the rule will be inserted. > Please check the effect of this option, as it does not work as you
// think! > Best way to use in conjunction with a data source. See [example](../data-sources/firewall.md#example-usage).
func (o IpFirewallFilterOutput) PlaceBefore() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *IpFirewallFilter) pulumi.StringPtrOutput { return v.PlaceBefore }).(pulumi.StringPtrOutput)
}

// Matches if any (source or destination) port matches the specified list of ports or port ranges. Applicable only if
// protocol is TCP or UDP
func (o IpFirewallFilterOutput) Port() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *IpFirewallFilter) pulumi.StringPtrOutput { return v.Port }).(pulumi.StringPtrOutput)
}

// Matches the packet's priority after a new priority has been set. Priority may be derived from VLAN, WMM, DSCP, MPLS EXP
// bit, or from the priority that has been set using the set-priority action.
func (o IpFirewallFilterOutput) Priority() pulumi.IntPtrOutput {
	return o.ApplyT(func(v *IpFirewallFilter) pulumi.IntPtrOutput { return v.Priority }).(pulumi.IntPtrOutput)
}

// Matches particular IP protocol specified by protocol name or number.
func (o IpFirewallFilterOutput) Protocol() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *IpFirewallFilter) pulumi.StringPtrOutput { return v.Protocol }).(pulumi.StringPtrOutput)
}

// Attempts to detect TCP and UDP scans. Parameters are in the following format WeightThreshold, DelayThreshold,
// LowPortWeight, HighPortWeight.
func (o IpFirewallFilterOutput) Psd() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *IpFirewallFilter) pulumi.StringPtrOutput { return v.Psd }).(pulumi.StringPtrOutput)
}

// Matches packets randomly with a given probability.
func (o IpFirewallFilterOutput) Random() pulumi.IntPtrOutput {
	return o.ApplyT(func(v *IpFirewallFilter) pulumi.IntPtrOutput { return v.Random }).(pulumi.IntPtrOutput)
}

// Specifies ICMP error to be sent back if the packet is rejected. Applicable if action=reject.
func (o IpFirewallFilterOutput) RejectWith() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *IpFirewallFilter) pulumi.StringPtrOutput { return v.RejectWith }).(pulumi.StringPtrOutput)
}

// Matches packets marked by mangle facility with particular routing mark.
func (o IpFirewallFilterOutput) RoutingMark() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *IpFirewallFilter) pulumi.StringPtrOutput { return v.RoutingMark }).(pulumi.StringPtrOutput)
}

// Matches packets which destination address is resolved in specific a routing table.
func (o IpFirewallFilterOutput) RoutingTable() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *IpFirewallFilter) pulumi.StringPtrOutput { return v.RoutingTable }).(pulumi.StringPtrOutput)
}

// Matches packets which source is equal to specified IP or falls into a specified IP range.
func (o IpFirewallFilterOutput) SrcAddress() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *IpFirewallFilter) pulumi.StringPtrOutput { return v.SrcAddress }).(pulumi.StringPtrOutput)
}

// Matches source address of a packet against user-defined address list.
func (o IpFirewallFilterOutput) SrcAddressList() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *IpFirewallFilter) pulumi.StringPtrOutput { return v.SrcAddressList }).(pulumi.StringPtrOutput)
}

// Matches source address type.
func (o IpFirewallFilterOutput) SrcAddressType() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *IpFirewallFilter) pulumi.StringPtrOutput { return v.SrcAddressType }).(pulumi.StringPtrOutput)
}

// Matches source MAC address of the packet.
func (o IpFirewallFilterOutput) SrcMacAddress() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *IpFirewallFilter) pulumi.StringPtrOutput { return v.SrcMacAddress }).(pulumi.StringPtrOutput)
}

// List of source ports and ranges of source ports. Applicable only if a protocol is TCP or UDP.
func (o IpFirewallFilterOutput) SrcPort() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *IpFirewallFilter) pulumi.StringPtrOutput { return v.SrcPort }).(pulumi.StringPtrOutput)
}

// Matches specified TCP flags.
func (o IpFirewallFilterOutput) TcpFlags() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *IpFirewallFilter) pulumi.StringPtrOutput { return v.TcpFlags }).(pulumi.StringPtrOutput)
}

// Matches TCP MSS value of an IP packet.
func (o IpFirewallFilterOutput) TcpMss() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *IpFirewallFilter) pulumi.StringPtrOutput { return v.TcpMss }).(pulumi.StringPtrOutput)
}

// Allows to create a filter based on the packets' arrival time and date or, for locally generated packets, departure time
// and date.
func (o IpFirewallFilterOutput) Time() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *IpFirewallFilter) pulumi.StringPtrOutput { return v.Time }).(pulumi.StringPtrOutput)
}

// Allows matching HTTPS traffic based on TLS SNI hostname.
func (o IpFirewallFilterOutput) TlsHost() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *IpFirewallFilter) pulumi.StringPtrOutput { return v.TlsHost }).(pulumi.StringPtrOutput)
}

// Matches packets TTL value.
func (o IpFirewallFilterOutput) Ttl() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *IpFirewallFilter) pulumi.StringPtrOutput { return v.Ttl }).(pulumi.StringPtrOutput)
}

type IpFirewallFilterArrayOutput struct{ *pulumi.OutputState }

func (IpFirewallFilterArrayOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*[]*IpFirewallFilter)(nil)).Elem()
}
...
func (o IpFirewallFilterArrayOutput) Index(i pulumi.IntInput) IpFirewallFilterOutput {
	return pulumi.All(o, i).ApplyT(func(vs []interface{}) *IpFirewallFilter {
		return vs[0].([]*IpFirewallFilter)[vs[1].(int)]
	}).(IpFirewallFilterOutput)
}
...
func (o IpFirewallFilterMapOutput) MapIndex(k pulumi.StringInput) IpFirewallFilterOutput {
	return pulumi.All(o, k).ApplyT(func(vs []interface{}) *IpFirewallFilter {
		return vs[0].(map[string]*IpFirewallFilter)[vs[1].(string)]
	}).(IpFirewallFilterOutput)
}

func init() {
	pulumi.RegisterInputType(reflect.TypeOf((*IpFirewallFilterInput)(nil)).Elem(), &IpFirewallFilter{})
	pulumi.RegisterInputType(reflect.TypeOf((*IpFirewallFilterArrayInput)(nil)).Elem(), IpFirewallFilterArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*IpFirewallFilterMapInput)(nil)).Elem(), IpFirewallFilterMap{})
	pulumi.RegisterOutputType(IpFirewallFilterOutput{})
	pulumi.RegisterOutputType(IpFirewallFilterArrayOutput{})
	pulumi.RegisterOutputType(IpFirewallFilterMapOutput{})
}
