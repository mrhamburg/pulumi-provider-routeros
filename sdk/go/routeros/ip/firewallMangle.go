...
// Please see documentation for Ip.IpFirewallMangle
...
func NewFirewallMangle(ctx *pulumi.Context,
	...
	var resource FirewallMangle
	err := ctx.RegisterResource("routeros:Ip/firewallMangle:FirewallMangle", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// GetFirewallMangle gets an existing FirewallMangle resource's state with the given name, ID, and optional
...
func GetFirewallMangle(ctx *pulumi.Context,
	...
	var resource FirewallMangle
	err := ctx.ReadResource("routeros:Ip/firewallMangle:FirewallMangle", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// Input properties used for looking up and filtering FirewallMangle resources.
...
func (FirewallMangleState) ElementType() reflect.Type {
	return reflect.TypeOf((*firewallMangleState)(nil)).Elem()
}
...
func (FirewallMangleArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*firewallMangleArgs)(nil)).Elem()
}
...
func (*FirewallMangle) ElementType() reflect.Type {
	return reflect.TypeOf((**FirewallMangle)(nil)).Elem()
}

func (i *FirewallMangle) ToFirewallMangleOutput() FirewallMangleOutput {
	return i.ToFirewallMangleOutputWithContext(context.Background())
}

func (i *FirewallMangle) ToFirewallMangleOutputWithContext(ctx context.Context) FirewallMangleOutput {
	return pulumi.ToOutputWithContext(ctx, i).(FirewallMangleOutput)
}

// FirewallMangleArrayInput is an input type that accepts FirewallMangleArray and FirewallMangleArrayOutput values.
// You can construct a concrete instance of `FirewallMangleArrayInput` via:
//
...
func (i FirewallMangleArray) ToFirewallMangleArrayOutput() FirewallMangleArrayOutput {
	return i.ToFirewallMangleArrayOutputWithContext(context.Background())
}

func (i FirewallMangleArray) ToFirewallMangleArrayOutputWithContext(ctx context.Context) FirewallMangleArrayOutput {
	return pulumi.ToOutputWithContext(ctx, i).(FirewallMangleArrayOutput)
}

// FirewallMangleMapInput is an input type that accepts FirewallMangleMap and FirewallMangleMapOutput values.
// You can construct a concrete instance of `FirewallMangleMapInput` via:
//
...
func (FirewallMangleMap) ElementType() reflect.Type {
	return reflect.TypeOf((*map[string]*FirewallMangle)(nil)).Elem()
}

func (i FirewallMangleMap) ToFirewallMangleMapOutput() FirewallMangleMapOutput {
	return i.ToFirewallMangleMapOutputWithContext(context.Background())
}

func (i FirewallMangleMap) ToFirewallMangleMapOutputWithContext(ctx context.Context) FirewallMangleMapOutput {
	return pulumi.ToOutputWithContext(ctx, i).(FirewallMangleMapOutput)
}
...
// <em>Resource ID type (.id / name). This is an internal service field, setting a value is not required.</em>
func (o FirewallMangleOutput) ___id_() pulumi.IntPtrOutput {
	return o.ApplyT(func(v *FirewallMangle) pulumi.IntPtrOutput { return v.___id_ }).(pulumi.IntPtrOutput)
}

// <em>Resource path for CRUD operations. This is an internal service field, setting a value is not required.</em>
func (o FirewallMangleOutput) ___path_() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *FirewallMangle) pulumi.StringPtrOutput { return v.___path_ }).(pulumi.StringPtrOutput)
}

// Action to take if a packet is matched by the rule.
func (o FirewallMangleOutput) Action() pulumi.StringOutput {
	return o.ApplyT(func(v *FirewallMangle) pulumi.StringOutput { return v.Action }).(pulumi.StringOutput)
}

// Name of the address list to be used. Applicable if action is add-dst-to-address-list or add-src-to-address-list.
func (o FirewallMangleOutput) AddressList() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *FirewallMangle) pulumi.StringPtrOutput { return v.AddressList }).(pulumi.StringPtrOutput)
}

// Time interval after which the address will be removed from the address list specified by address-list parameter. Used in
// conjunction with add-dst-to-address-list or add-src-to-address-list actions.
func (o FirewallMangleOutput) AddressListTimeout() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *FirewallMangle) pulumi.StringPtrOutput { return v.AddressListTimeout }).(pulumi.StringPtrOutput)
}

// The total amount of bytes matched by the rule.
func (o FirewallMangleOutput) Bytes() pulumi.IntOutput {
	return o.ApplyT(func(v *FirewallMangle) pulumi.IntOutput { return v.Bytes }).(pulumi.IntOutput)
}

// Specifies to which chain rule will be added. If the input does not match the name of an already defined chain, a new
// chain will be created.
func (o FirewallMangleOutput) Chain() pulumi.StringOutput {
	return o.ApplyT(func(v *FirewallMangle) pulumi.StringOutput { return v.Chain }).(pulumi.StringOutput)
}

func (o FirewallMangleOutput) Comment() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *FirewallMangle) pulumi.StringPtrOutput { return v.Comment }).(pulumi.StringPtrOutput)
}

// Matches packets only if a given amount of bytes has been transfered through the particular connection.
func (o FirewallMangleOutput) ConnectionBytes() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *FirewallMangle) pulumi.StringPtrOutput { return v.ConnectionBytes }).(pulumi.StringPtrOutput)
}

// Matches connections per address or address block after given value is reached. Should be used together with
// connection-state=new and/or with tcp-flags=syn because matcher is very resource intensive.
func (o FirewallMangleOutput) ConnectionLimit() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *FirewallMangle) pulumi.StringPtrOutput { return v.ConnectionLimit }).(pulumi.StringPtrOutput)
}

// Matches packets marked via mangle facility with particular connection mark. If no-mark is set, rule will match any
// unmarked connection.
func (o FirewallMangleOutput) ConnectionMark() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *FirewallMangle) pulumi.StringPtrOutput { return v.ConnectionMark }).(pulumi.StringPtrOutput)
}

// Can match connections that are srcnatted, dstnatted or both.
func (o FirewallMangleOutput) ConnectionNatState() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *FirewallMangle) pulumi.StringPtrOutput { return v.ConnectionNatState }).(pulumi.StringPtrOutput)
}

// Connection Rate is a firewall matcher that allow to capture traffic based on present speed of the connection
// (0..4294967295).
func (o FirewallMangleOutput) ConnectionRate() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *FirewallMangle) pulumi.StringPtrOutput { return v.ConnectionRate }).(pulumi.StringPtrOutput)
}

// Interprets the connection tracking analysis data for a particular packet.
func (o FirewallMangleOutput) ConnectionState() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *FirewallMangle) pulumi.StringPtrOutput { return v.ConnectionState }).(pulumi.StringPtrOutput)
}

// Matches packets from related connections based on information from their connection tracking helpers.
func (o FirewallMangleOutput) ConnectionType() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *FirewallMangle) pulumi.StringPtrOutput { return v.ConnectionType }).(pulumi.StringPtrOutput)
}

// Match packets that contain specified text.
func (o FirewallMangleOutput) Content() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *FirewallMangle) pulumi.StringPtrOutput { return v.Content }).(pulumi.StringPtrOutput)
}

func (o FirewallMangleOutput) Disabled() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v *FirewallMangle) pulumi.BoolPtrOutput { return v.Disabled }).(pulumi.BoolPtrOutput)
}

// Matches DSCP IP header field.
func (o FirewallMangleOutput) Dscp() pulumi.IntPtrOutput {
	return o.ApplyT(func(v *FirewallMangle) pulumi.IntPtrOutput { return v.Dscp }).(pulumi.IntPtrOutput)
}

// Matches packets which destination is equal to specified IP or falls into specified IP range.
func (o FirewallMangleOutput) DstAddress() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *FirewallMangle) pulumi.StringPtrOutput { return v.DstAddress }).(pulumi.StringPtrOutput)
}

// Matches destination address of a packet against user-defined address list.
func (o FirewallMangleOutput) DstAddressList() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *FirewallMangle) pulumi.StringPtrOutput { return v.DstAddressList }).(pulumi.StringPtrOutput)
}

// Matches destination address type.
func (o FirewallMangleOutput) DstAddressType() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *FirewallMangle) pulumi.StringPtrOutput { return v.DstAddressType }).(pulumi.StringPtrOutput)
}

// Matches packets until a given rate is exceeded.
func (o FirewallMangleOutput) DstLimit() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *FirewallMangle) pulumi.StringPtrOutput { return v.DstLimit }).(pulumi.StringPtrOutput)
}

// List of destination port numbers or port number ranges.
func (o FirewallMangleOutput) DstPort() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *FirewallMangle) pulumi.StringPtrOutput { return v.DstPort }).(pulumi.StringPtrOutput)
}

// Configuration item created by software, not by management interface. It is not exported, and cannot be directly
// modified.
func (o FirewallMangleOutput) Dynamic() pulumi.BoolOutput {
	return o.ApplyT(func(v *FirewallMangle) pulumi.BoolOutput { return v.Dynamic }).(pulumi.BoolOutput)
}

// Matches fragmented packets. First (starting) fragment does not count. If connection tracking is enabled there will be no
// fragments as system automatically assembles every packet
func (o FirewallMangleOutput) Fragment() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v *FirewallMangle) pulumi.BoolPtrOutput { return v.Fragment }).(pulumi.BoolPtrOutput)
}

// Matches packets received from HotSpot clients against various HotSpot matchers.
func (o FirewallMangleOutput) Hotspot() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *FirewallMangle) pulumi.StringPtrOutput { return v.Hotspot }).(pulumi.StringPtrOutput)
}

// Matches ICMP type: code fields.
func (o FirewallMangleOutput) IcmpOptions() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *FirewallMangle) pulumi.StringPtrOutput { return v.IcmpOptions }).(pulumi.StringPtrOutput)
}

// Actual interface the packet has entered the router if the incoming interface is a bridge. Works only if use-ip-firewall
// is enabled in bridge settings.
func (o FirewallMangleOutput) InBridgePort() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *FirewallMangle) pulumi.StringPtrOutput { return v.InBridgePort }).(pulumi.StringPtrOutput)
}

// Set of interfaces defined in interface list. Works the same as in-bridge-port.
func (o FirewallMangleOutput) InBridgePortList() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *FirewallMangle) pulumi.StringPtrOutput { return v.InBridgePortList }).(pulumi.StringPtrOutput)
}

// Interface the packet has entered the router.
func (o FirewallMangleOutput) InInterface() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *FirewallMangle) pulumi.StringPtrOutput { return v.InInterface }).(pulumi.StringPtrOutput)
}

// Set of interfaces defined in interface list. Works the same as in-interface.
func (o FirewallMangleOutput) InInterfaceList() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *FirewallMangle) pulumi.StringPtrOutput { return v.InInterfaceList }).(pulumi.StringPtrOutput)
}

// Matches the priority of an ingress packet. Priority may be derived from VLAN, WMM, DSCP, or MPLS EXP bit.
func (o FirewallMangleOutput) IngressPriority() pulumi.IntPtrOutput {
	return o.ApplyT(func(v *FirewallMangle) pulumi.IntPtrOutput { return v.IngressPriority }).(pulumi.IntPtrOutput)
}

func (o FirewallMangleOutput) Invalid() pulumi.BoolOutput {
	return o.ApplyT(func(v *FirewallMangle) pulumi.BoolOutput { return v.Invalid }).(pulumi.BoolOutput)
}

// Matches the policy used by IPsec. Value is written in the following format: direction, policy.
func (o FirewallMangleOutput) IpsecPolicy() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *FirewallMangle) pulumi.StringPtrOutput { return v.IpsecPolicy }).(pulumi.StringPtrOutput)
}

// Matches IPv4 header options.
func (o FirewallMangleOutput) Ipv4Options() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *FirewallMangle) pulumi.StringPtrOutput { return v.Ipv4Options }).(pulumi.StringPtrOutput)
}

// Name of the target chain to jump to. Applicable only if action=jump.
func (o FirewallMangleOutput) JumpTarget() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *FirewallMangle) pulumi.StringPtrOutput { return v.JumpTarget }).(pulumi.StringPtrOutput)
}

// Layer7 filter name.
func (o FirewallMangleOutput) Layer7Protocol() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *FirewallMangle) pulumi.StringPtrOutput { return v.Layer7Protocol }).(pulumi.StringPtrOutput)
}

// Matches packets up to a limited rate (packet rate or bit rate). A rule using this matcher will match until this limit is
// reached. Parameters are written in the following format: rate[/time],burst:mode.
func (o FirewallMangleOutput) Limit() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *FirewallMangle) pulumi.StringPtrOutput { return v.Limit }).(pulumi.StringPtrOutput)
}

// Add a message to the system log.
func (o FirewallMangleOutput) Log() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v *FirewallMangle) pulumi.BoolPtrOutput { return v.Log }).(pulumi.BoolPtrOutput)
}

// Adds specified text at the beginning of every log message. Applicable if action=log or log=yes configured.
func (o FirewallMangleOutput) LogPrefix() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *FirewallMangle) pulumi.StringPtrOutput { return v.LogPrefix }).(pulumi.StringPtrOutput)
}

// Sets a new connection-mark value.
func (o FirewallMangleOutput) NewConnectionMark() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *FirewallMangle) pulumi.StringPtrOutput { return v.NewConnectionMark }).(pulumi.StringPtrOutput)
}

// Sets a new DSCP value for a packet.
func (o FirewallMangleOutput) NewDscp() pulumi.IntPtrOutput {
	return o.ApplyT(func(v *FirewallMangle) pulumi.IntPtrOutput { return v.NewDscp }).(pulumi.IntPtrOutput)
}
...
// messages with a code meaning "fragmentation needed and DF set". > Upon receipt of such a message, the source host
// reduces its assumed PMTU for the path.
func (o FirewallMangleOutput) NewMss() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *FirewallMangle) pulumi.StringPtrOutput { return v.NewMss }).(pulumi.StringPtrOutput)
}

// Sets a new packet-mark value.
func (o FirewallMangleOutput) NewPacketMark() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *FirewallMangle) pulumi.StringPtrOutput { return v.NewPacketMark }).(pulumi.StringPtrOutput)
}

// Sets a new priority for a packet. This can be the VLAN, WMM, DSCP or MPLS EXP priority. This property can also be used
// to set an internal priority.
func (o FirewallMangleOutput) NewPriority() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *FirewallMangle) pulumi.StringPtrOutput { return v.NewPriority }).(pulumi.StringPtrOutput)
}

// Sets a new routing-mark value.
func (o FirewallMangleOutput) NewRoutingMark() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *FirewallMangle) pulumi.StringPtrOutput { return v.NewRoutingMark }).(pulumi.StringPtrOutput)
}

// Sets a new TTL for a packet.
func (o FirewallMangleOutput) NewTtl() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *FirewallMangle) pulumi.StringPtrOutput { return v.NewTtl }).(pulumi.StringPtrOutput)
}

// Matches every nth packet: nth=2,1 rule will match every first packet of 2, hence, 50% of all the traffic that is matched
// by the rule
func (o FirewallMangleOutput) Nth() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *FirewallMangle) pulumi.StringPtrOutput { return v.Nth }).(pulumi.StringPtrOutput)
}

// Actual interface the packet is leaving the router if the outgoing interface is a bridge. Works only if use-ip-firewall
// is enabled in bridge settings.
func (o FirewallMangleOutput) OutBridgePort() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *FirewallMangle) pulumi.StringPtrOutput { return v.OutBridgePort }).(pulumi.StringPtrOutput)
}

// Set of interfaces defined in interface list. Works the same as out-bridge-port.
func (o FirewallMangleOutput) OutBridgePortList() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *FirewallMangle) pulumi.StringPtrOutput { return v.OutBridgePortList }).(pulumi.StringPtrOutput)
}

// Interface the packet is leaving the router.
func (o FirewallMangleOutput) OutInterface() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *FirewallMangle) pulumi.StringPtrOutput { return v.OutInterface }).(pulumi.StringPtrOutput)
}

// Set of interfaces defined in interface list. Works the same as out-interface.
func (o FirewallMangleOutput) OutInterfaceList() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *FirewallMangle) pulumi.StringPtrOutput { return v.OutInterfaceList }).(pulumi.StringPtrOutput)
}

// Matches packets marked via mangle facility with particular packet mark. If no-mark is set, the rule will match any
// unmarked packet.
func (o FirewallMangleOutput) PacketMark() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *FirewallMangle) pulumi.StringPtrOutput { return v.PacketMark }).(pulumi.StringPtrOutput)
}

// Matches packets of specified size or size range in bytes.
func (o FirewallMangleOutput) PacketSize() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *FirewallMangle) pulumi.StringPtrOutput { return v.PacketSize }).(pulumi.StringPtrOutput)
}

// The total amount of packets matched by the rule.
func (o FirewallMangleOutput) Packets() pulumi.IntOutput {
	return o.ApplyT(func(v *FirewallMangle) pulumi.IntOutput { return v.Packets }).(pulumi.IntOutput)
}

// Whether to let the packet to pass further (like action passthrough) into the firewall or not (property only valid some
// actions).
func (o FirewallMangleOutput) Passthrough() pulumi.BoolOutput {
	return o.ApplyT(func(v *FirewallMangle) pulumi.BoolOutput { return v.Passthrough }).(pulumi.BoolOutput)
}

// PCC matcher allows dividing traffic into equal streams with the ability to keep packets with a specific set of options
// in one particular stream.
func (o FirewallMangleOutput) PerConnectionClassifier() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *FirewallMangle) pulumi.StringPtrOutput { return v.PerConnectionClassifier }).(pulumi.StringPtrOutput)
}

// Before which position the rule will be inserted. > Please check the effect of this option, as it does not work as you
// think! > Best way to use in conjunction with a data source. See [example](../data-sources/firewall.md#example-usage).
func (o FirewallMangleOutput) PlaceBefore() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *FirewallMangle) pulumi.StringPtrOutput { return v.PlaceBefore }).(pulumi.StringPtrOutput)
}

// Matches if any (source or destination) port matches the specified list of ports or port ranges. Applicable only if
// protocol is TCP or UDP
func (o FirewallMangleOutput) Port() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *FirewallMangle) pulumi.StringPtrOutput { return v.Port }).(pulumi.StringPtrOutput)
}

// Matches particular IP protocol specified by protocol name or number.
func (o FirewallMangleOutput) Protocol() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *FirewallMangle) pulumi.StringPtrOutput { return v.Protocol }).(pulumi.StringPtrOutput)
}

// Attempts to detect TCP and UDP scans. Parameters are in the following format WeightThreshold, DelayThreshold,
// LowPortWeight, HighPortWeight.
func (o FirewallMangleOutput) Psd() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *FirewallMangle) pulumi.StringPtrOutput { return v.Psd }).(pulumi.StringPtrOutput)
}

// Matches packets randomly with a given probability.
func (o FirewallMangleOutput) Random() pulumi.IntPtrOutput {
	return o.ApplyT(func(v *FirewallMangle) pulumi.IntPtrOutput { return v.Random }).(pulumi.IntPtrOutput)
}

// Matches packets with a specific gateway.
func (o FirewallMangleOutput) RouteDst() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *FirewallMangle) pulumi.StringPtrOutput { return v.RouteDst }).(pulumi.StringPtrOutput)
}

// Matches packets marked by mangle facility with particular routing mark.
func (o FirewallMangleOutput) RoutingMark() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *FirewallMangle) pulumi.StringPtrOutput { return v.RoutingMark }).(pulumi.StringPtrOutput)
}

// Matches packets which source is equal to specified IP or falls into a specified IP range.
func (o FirewallMangleOutput) SrcAddress() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *FirewallMangle) pulumi.StringPtrOutput { return v.SrcAddress }).(pulumi.StringPtrOutput)
}

// Matches source address of a packet against user-defined address list.
func (o FirewallMangleOutput) SrcAddressList() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *FirewallMangle) pulumi.StringPtrOutput { return v.SrcAddressList }).(pulumi.StringPtrOutput)
}

// Matches source address type.
func (o FirewallMangleOutput) SrcAddressType() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *FirewallMangle) pulumi.StringPtrOutput { return v.SrcAddressType }).(pulumi.StringPtrOutput)
}

// Matches source MAC address of the packet.
func (o FirewallMangleOutput) SrcMacAddress() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *FirewallMangle) pulumi.StringPtrOutput { return v.SrcMacAddress }).(pulumi.StringPtrOutput)
}

// List of source ports and ranges of source ports. Applicable only if a protocol is TCP or UDP.
func (o FirewallMangleOutput) SrcPort() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *FirewallMangle) pulumi.StringPtrOutput { return v.SrcPort }).(pulumi.StringPtrOutput)
}

// Matches specified TCP flags.
func (o FirewallMangleOutput) TcpFlags() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *FirewallMangle) pulumi.StringPtrOutput { return v.TcpFlags }).(pulumi.StringPtrOutput)
}

// Matches TCP MSS value of an IP packet.
func (o FirewallMangleOutput) TcpMss() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *FirewallMangle) pulumi.StringPtrOutput { return v.TcpMss }).(pulumi.StringPtrOutput)
}

// Allows to create a filter based on the packets' arrival time and date or, for locally generated packets, departure time
// and date.
func (o FirewallMangleOutput) Time() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *FirewallMangle) pulumi.StringPtrOutput { return v.Time }).(pulumi.StringPtrOutput)
}

// Allows matching HTTPS traffic based on TLS SNI hostname.
func (o FirewallMangleOutput) TlsHost() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *FirewallMangle) pulumi.StringPtrOutput { return v.TlsHost }).(pulumi.StringPtrOutput)
}

// Matches packets TTL value.
func (o FirewallMangleOutput) Ttl() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *FirewallMangle) pulumi.StringPtrOutput { return v.Ttl }).(pulumi.StringPtrOutput)
}
...
func (o FirewallMangleArrayOutput) Index(i pulumi.IntInput) FirewallMangleOutput {
	return pulumi.All(o, i).ApplyT(func(vs []interface{}) *FirewallMangle {
		return vs[0].([]*FirewallMangle)[vs[1].(int)]
	}).(FirewallMangleOutput)
}
...
func (o FirewallMangleMapOutput) MapIndex(k pulumi.StringInput) FirewallMangleOutput {
	return pulumi.All(o, k).ApplyT(func(vs []interface{}) *FirewallMangle {
		return vs[0].(map[string]*FirewallMangle)[vs[1].(string)]
	}).(FirewallMangleOutput)
}

func init() {
	pulumi.RegisterInputType(reflect.TypeOf((*FirewallMangleInput)(nil)).Elem(), &FirewallMangle{})
	pulumi.RegisterInputType(reflect.TypeOf((*FirewallMangleArrayInput)(nil)).Elem(), FirewallMangleArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*FirewallMangleMapInput)(nil)).Elem(), FirewallMangleMap{})
	pulumi.RegisterOutputType(FirewallMangleOutput{})
	pulumi.RegisterOutputType(FirewallMangleArrayOutput{})
	pulumi.RegisterOutputType(FirewallMangleMapOutput{})
}
