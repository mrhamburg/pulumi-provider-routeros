...
func NewFirewallFilter(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("routeros:Ipv6/firewallFilter:FirewallFilter", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFirewallFilter(ctx *pulumi.Context,
	...
	var resource FirewallFilter
	err := ctx.ReadResource("routeros:Ipv6/firewallFilter:FirewallFilter", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func (o FirewallFilterOutput) AddressListTimeout() pulumi.StringOutput {
	return o.ApplyT(func(v *FirewallFilter) pulumi.StringOutput { return v.AddressListTimeout }).(pulumi.StringOutput)
}
...
// Extension headers. Look at the Extras tab in the v6 filter rules.
func (o FirewallFilterOutput) Headers() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *FirewallFilter) pulumi.StringPtrOutput { return v.Headers }).(pulumi.StringPtrOutput)
}

// IPv6 TTL. Look at the Extras tab in the v6 filter rules.
func (o FirewallFilterOutput) HopLimit() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *FirewallFilter) pulumi.StringPtrOutput { return v.HopLimit }).(pulumi.StringPtrOutput)
}
